...
{$M+}
  ...
  PCFHostClientCallBack = ^CFHostClientCallBack;
  CFTypeID = LongWord;
  PCFTypeID = ^CFTypeID;
  ...
  PCFNetServiceClientCallBack = ^CFNetServiceClientCallBack;
  ...
  PCFNetServiceMonitorClientCallBack = ^CFNetServiceMonitorClientCallBack;
  CFTypeRef = Pointer;
  ...
  PCFNetServiceBrowserClientCallBack = ^CFNetServiceBrowserClientCallBack;
  ...
  PCFProxyAutoConfigurationResultCallback = ^
...
function kCFHTTPVersion3_0: Pointer;
...
function kCFStreamNetworkServiceTypeResponsiveData: Pointer;
function kCFStreamNetworkServiceTypeCallSignaling: Pointer;
function kCFStreamNetworkServiceTypeAVStreaming: Pointer;
function kCFStreamNetworkServiceTypeResponsiveAV: Pointer;
...
function kCFStreamPropertyAllowExpensiveNetworkAccess: Pointer;
function kCFStreamPropertyConnectionIsExpensive: Pointer;
function kCFStreamPropertyAllowConstrainedNetworkAccess: Pointer;
...
function CFHostGetAddressing(theHost: CFHostRef; hasBeenResolved: PBoolean)
  : CFArrayRef; cdecl; external libCFNetwork name _PU + 'CFHostGetAddressing';
function CFHostGetNames(theHost: CFHostRef; hasBeenResolved: PBoolean)
  : CFArrayRef; cdecl; external libCFNetwork name _PU + 'CFHostGetNames';
function CFHostGetReachability(theHost: CFHostRef; hasBeenResolved: PBoolean)
...
function CFHostSetClient(theHost: CFHostRef; clientCB: CFHostClientCallBack;
  clientContext: PCFHostClientContext): Boolean; cdecl;
...
function CFNetDiagnosticCopyNetworkStatusPassively(details: CFNetDiagnosticRef;
  description: PCFStringRef): CFNetDiagnosticStatus; cdecl;
...
function CFNetServiceSetClient(theService: CFNetServiceRef;
  ...
  clientContext: PCFNetServiceClientContext): Boolean; cdecl;
...
function CFNetServiceMonitorCreate(alloc: CFAllocatorRef;
  ...
  clientContext: PCFNetServiceClientContext): CFNetServiceMonitorRef; cdecl;
...
function CFNetServiceBrowserCreate(alloc: CFAllocatorRef;
  ...
  clientContext: PCFNetServiceClientContext): CFNetServiceBrowserRef; cdecl;
...
procedure CFStreamCreatePairWithSocketToCFHost(alloc: CFAllocatorRef;
  host: CFHostRef; port: Int32; readStream: PCFReadStreamRef;
  writeStream: PCFWriteStreamRef); cdecl;
  external libCFNetwork name _PU + 'CFStreamCreatePairWithSocketToCFHost';
procedure CFStreamCreatePairWithSocketToNetService(alloc: CFAllocatorRef;
  service: CFNetServiceRef; readStream: PCFReadStreamRef;
  writeStream: PCFWriteStreamRef); cdecl;
...
function CFNetworkCopyProxiesForAutoConfigurationScript
  ...
  error: PCFErrorRef): CFArrayRef; cdecl;
  external libCFNetwork name _PU +
...
function kCFHTTPVersion3_0: Pointer;
begin
  Result := CocoaPointerConst(libCFNetwork, 'kCFHTTPVersion3_0');
end;
