...
const
  ...
  kCFURLBookmarkCreationWithoutImplicitSecurityScope = (1 shl 29);
  ...
  kCFURLBookmarkResolutionWithoutImplicitStartAccessing = (1 shl 15);
  ...
  kCFISO8601DateFormatWithYear = (1 shl 0);
  kCFISO8601DateFormatWithMonth = (1 shl 1);
  kCFISO8601DateFormatWithWeekOfYear = (1 shl 2);
  kCFISO8601DateFormatWithDay = (1 shl 4);
  kCFISO8601DateFormatWithTime = (1 shl 5);
  kCFISO8601DateFormatWithTimeZone = (1 shl 6);
  kCFISO8601DateFormatWithSpaceBetweenDateAndTime = (1 shl 7);
  kCFISO8601DateFormatWithDashSeparatorInDate = (1 shl 8);
  kCFISO8601DateFormatWithColonSeparatorInTime = (1 shl 9);
  kCFISO8601DateFormatWithColonSeparatorInTimeZone = (1 shl 10);
  kCFISO8601DateFormatWithFractionalSeconds = (1 shl 11);
  kCFISO8601DateFormatWithFullDate = kCFISO8601DateFormatWithYear or
    kCFISO8601DateFormatWithMonth or kCFISO8601DateFormatWithDay or
    kCFISO8601DateFormatWithDashSeparatorInDate;
  kCFISO8601DateFormatWithFullTime = kCFISO8601DateFormatWithTime or
    kCFISO8601DateFormatWithColonSeparatorInTime or
    kCFISO8601DateFormatWithTimeZone or
    kCFISO8601DateFormatWithColonSeparatorInTimeZone;
  kCFISO8601DateFormatWithInternetDateTime = kCFISO8601DateFormatWithFullDate or
  ...
  kCFPropertyListMutableContainers = 1 shl 0;
  kCFPropertyListMutableContainersAndLeaves = 1 shl 1;
  ...
  kCFURLEnumeratorGenerateRelativePathURLs = 1 shl 6;
...
{$M+}
  ...
  PCFComparatorFunction = ^CFComparatorFunction;
  ...
  CFArrayRetainCallBack = function(param1: CFAllocatorRef; param2: Pointer)
    : Pointer; cdecl;
  PCFArrayRetainCallBack = ^CFArrayRetainCallBack;
  CFArrayReleaseCallBack = procedure(param1: CFAllocatorRef;
    param2: Pointer); cdecl;
  PCFArrayReleaseCallBack = ^CFArrayReleaseCallBack;
  CFArrayCopyDescriptionCallBack = function(param1: Pointer)
    : CFStringRef; cdecl;
  PCFArrayCopyDescriptionCallBack = ^CFArrayCopyDescriptionCallBack;
  CFArrayEqualCallBack = function(param1: Pointer; param2: Pointer)
    : Boolean; cdecl;
  PCFArrayEqualCallBack = ^CFArrayEqualCallBack;
  ...
  PCFArrayApplierFunction = ^CFArrayApplierFunction;
  CFArrayRef = Pointer;
  ...
  CFDictionaryRetainCallBack = function(param1: CFAllocatorRef; param2: Pointer)
    : Pointer; cdecl;
  PCFDictionaryRetainCallBack = ^CFDictionaryRetainCallBack;
  CFDictionaryReleaseCallBack = procedure(param1: CFAllocatorRef;
    param2: Pointer); cdecl;
  PCFDictionaryReleaseCallBack = ^CFDictionaryReleaseCallBack;
  CFDictionaryCopyDescriptionCallBack = function(param1: Pointer)
    : CFStringRef; cdecl;
  PCFDictionaryCopyDescriptionCallBack = ^CFDictionaryCopyDescriptionCallBack;
  CFDictionaryEqualCallBack = function(param1: Pointer; param2: Pointer)
    : Boolean; cdecl;
  PCFDictionaryEqualCallBack = ^CFDictionaryEqualCallBack;
  CFDictionaryHashCallBack = function(param1: Pointer): CFHashCode; cdecl;
  PCFDictionaryHashCallBack = ^CFDictionaryHashCallBack;
  ...
  PCFDictionaryApplierFunction = ^CFDictionaryApplierFunction;
  ...
  PCFNotificationName = ^CFNotificationName;
  ...
  CFNotificationCallback = procedure(param1: CFNotificationCenterRef;
    param2: Pointer; param3: CFNotificationName; param4: Pointer;
    param5: CFDictionaryRef); cdecl;
  PCFNotificationCallback = ^CFNotificationCallback;
  CFNotificationSuspensionBehavior = CFIndex;
  CFLocaleIdentifier = CFStringRef;
  PCFLocaleIdentifier = ^CFLocaleIdentifier;
  CFLocaleKey = CFStringRef;
  PCFLocaleKey = ^CFLocaleKey;
  CFLocaleRef = Pointer;
  ...
  PCFCalendarIdentifier = ^CFCalendarIdentifier;
  CFErrorDomain = CFStringRef;
  PCFErrorDomain = ^CFErrorDomain;
  CFErrorRef = Pointer;
  ...
  PConstStringPtr = ^ConstStringPtr;
  ...
  PCFBagApplierFunction = ^CFBagApplierFunction;
  CFBagRef = Pointer;
  PCFBagRef = ^CFBagRef;
  ...
  CFBinaryHeapApplierFunction = procedure(param1: Pointer;
    param2: Pointer); cdecl;
  PCFBinaryHeapApplierFunction = ^CFBinaryHeapApplierFunction;
  ...
  PCFURLBookmarkFileCreationOptions = ^CFURLBookmarkFileCreationOptions;
  CFBundleRef = Pointer;
  ...
  PCFDateFormatterKey = ^CFDateFormatterKey;
  ...
  PCFRunLoopObserverCallBack = ^CFRunLoopObserverCallBack;
  ...
  CFRunLoopTimerCallBack = procedure(param1: CFRunLoopTimerRef;
    param2: Pointer); cdecl;
  PCFRunLoopTimerCallBack = ^CFRunLoopTimerCallBack;
  ...
  PCFFileDescriptorCallBack = ^CFFileDescriptorCallBack;
  ...
  PCFMachPortCallBack = ^CFMachPortCallBack;
  CFMachPortInvalidationCallBack = procedure(param1: CFMachPortRef;
    param2: Pointer); cdecl;
  PCFMachPortInvalidationCallBack = ^CFMachPortInvalidationCallBack;
  ...
  PCFMessagePortCallBack = ^CFMessagePortCallBack;
  CFMessagePortInvalidationCallBack = procedure(param1: CFMessagePortRef;
    param2: Pointer); cdecl;
  PCFMessagePortInvalidationCallBack = ^CFMessagePortInvalidationCallBack;
  ...
  PCFNumberFormatterKey = ^CFNumberFormatterKey;
  ...
  PCFSocketCallBack = ^CFSocketCallBack;
  ...
  PCFStreamPropertyKey = ^CFStreamPropertyKey;
  ...
  PCFReadStreamClientCallBack = ^CFReadStreamClientCallBack;
  CFWriteStreamClientCallBack = procedure(param1: CFWriteStreamRef;
    param2: CFStreamEventType; param3: Pointer); cdecl;
  PCFWriteStreamClientCallBack = ^CFWriteStreamClientCallBack;
  ...
  PCFSetApplierFunction = ^CFSetApplierFunction;
  CFSetRef = Pointer;
  PCFSetRef = ^CFSetRef;
  CFMutableSetRef = Pointer;
  PCFMutableSetRef = ^CFMutableSetRef;
  ...
  PCFTreeRetainCallBack = ^CFTreeRetainCallBack;
  CFTreeReleaseCallBack = procedure(param1: Pointer); cdecl;
  PCFTreeReleaseCallBack = ^CFTreeReleaseCallBack;
  CFTreeCopyDescriptionCallBack = function(param1: Pointer): CFStringRef; cdecl;
  PCFTreeCopyDescriptionCallBack = ^CFTreeCopyDescriptionCallBack;
  ...
  PCFTreeApplierFunction = ^CFTreeApplierFunction;
  CFTreeRef = Pointer;
  ...
  CFUserNotificationCallBack = procedure(param1: CFUserNotificationRef;
    param2: CFOptionFlags); cdecl;
  PCFUserNotificationCallBack = ^CFUserNotificationCallBack;
...
function kCFErrorLocalizedFailureKey: Pointer;
...
function kCFURLFileIdentifierKey: Pointer;
function kCFURLFileContentIdentifierKey: Pointer;
function kCFURLMayShareFileContentKey: Pointer;
function kCFURLMayHaveExtendedAttributesKey: Pointer;
function kCFURLIsPurgeableKey: Pointer;
function kCFURLIsSparseKey: Pointer;
...
function kCFURLCanonicalPathKey: Pointer;
...
function kCFURLVolumeAvailableCapacityForImportantUsageKey: Pointer;
function kCFURLVolumeAvailableCapacityForOpportunisticUsageKey: Pointer;
...
function kCFURLVolumeIsEncryptedKey: Pointer;
function kCFURLVolumeIsRootFileSystemKey: Pointer;
function kCFURLVolumeSupportsCompressionKey: Pointer;
function kCFURLVolumeSupportsFileCloningKey: Pointer;
function kCFURLVolumeSupportsSwapRenamingKey: Pointer;
function kCFURLVolumeSupportsExclusiveRenamingKey: Pointer;
function kCFURLVolumeSupportsImmutableFilesKey: Pointer;
function kCFURLVolumeSupportsAccessPermissionsKey: Pointer;
function kCFURLVolumeSupportsFileProtectionKey: Pointer;
function kCFURLVolumeTypeNameKey: Pointer;
function kCFURLVolumeSubtypeKey: Pointer;
function kCFURLVolumeMountFromLocationKey: Pointer;
...
function kCFURLUbiquitousItemIsExcludedFromSyncKey: Pointer;
...
function kCFUserNotificationIconURLKey: Pointer;
function kCFUserNotificationSoundURLKey: Pointer;
function kCFUserNotificationLocalizationURLKey: Pointer;
function kCFUserNotificationAlertHeaderKey: Pointer;
function kCFUserNotificationAlertMessageKey: Pointer;
function kCFUserNotificationDefaultButtonTitleKey: Pointer;
function kCFUserNotificationAlternateButtonTitleKey: Pointer;
function kCFUserNotificationOtherButtonTitleKey: Pointer;
function kCFUserNotificationProgressIndicatorValueKey: Pointer;
function kCFUserNotificationPopUpTitlesKey: Pointer;
function kCFUserNotificationTextFieldTitlesKey: Pointer;
function kCFUserNotificationCheckBoxTitlesKey: Pointer;
function kCFUserNotificationTextFieldValuesKey: Pointer;
function kCFUserNotificationPopUpSelectionKey: Pointer;
function kCFUserNotificationAlertTopMostKey: Pointer;
function kCFUserNotificationKeyboardTypesKey: Pointer;
...
function CFAllocatorCreate(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFAllocatorCreate';
...
procedure CFAllocatorGetContext(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFAllocatorGetContext';
...
function CFDictionaryCreate(allocator: CFAllocatorRef; keys: Pointer;
  values: Pointer; numValues: CFIndex; keyCallBacks: PCFDictionaryKeyCallBacks;
  valueCallBacks: PCFDictionaryValueCallBacks): CFDictionaryRef; cdecl;
...
function CFDictionaryCreateMutable(allocator: CFAllocatorRef; capacity: CFIndex;
  keyCallBacks: PCFDictionaryKeyCallBacks;
  valueCallBacks: PCFDictionaryValueCallBacks): CFMutableDictionaryRef; cdecl;
  external libCoreFoundation name _PU + 'CFDictionaryCreateMutable';
...
procedure CFNotificationCenterRemoveObserver(center: CFNotificationCenterRef;
  observer: Pointer; name: CFNotificationName; &object: Pointer); cdecl;
...
procedure CFNotificationCenterPostNotification(center: CFNotificationCenterRef;
  name: CFNotificationName; &object: Pointer; userInfo: CFDictionaryRef;
...
procedure CFNotificationCenterPostNotificationWithOptions
  (center: CFNotificationCenterRef; name: CFNotificationName; &object: Pointer;
...
function CFLocaleCreateCanonicalLanguageIdentifierFromString
  (allocator: CFAllocatorRef; localeIdentifier: CFStringRef)
  : CFLocaleIdentifier; cdecl;
  external libCoreFoundation name _PU +
...
function CFLocaleCreateCanonicalLocaleIdentifierFromScriptManagerCodes
  (allocator: CFAllocatorRef; lcode: LangCode; rcode: RegionCode)
  : CFLocaleIdentifier; cdecl;
  external libCoreFoundation name _PU +
...
function CFLocaleCreateLocaleIdentifierFromWindowsLocaleCode
  (allocator: CFAllocatorRef; lcid: LongWord): CFLocaleIdentifier; cdecl;
  external libCoreFoundation name _PU +
...
function CFLocaleGetWindowsLocaleCodeFromLocaleIdentifier(localeIdentifier
  : CFLocaleIdentifier): LongWord; cdecl;
  external libCoreFoundation name _PU +
...
function CFLocaleCreateComponentsFromLocaleIdentifier(allocator: CFAllocatorRef;
  localeID: CFLocaleIdentifier): CFDictionaryRef; cdecl;
  external libCoreFoundation name _PU +
...
function CFLocaleCreateLocaleIdentifierFromComponents(allocator: CFAllocatorRef;
  dictionary: CFDictionaryRef): CFLocaleIdentifier; cdecl;
  external libCoreFoundation name _PU +
  'CFLocaleCreateLocaleIdentifierFromComponents';
function CFLocaleCreate(allocator: CFAllocatorRef;
  localeIdentifier: CFLocaleIdentifier): CFLocaleRef; cdecl;
...
function CFLocaleCreateCopy(allocator: CFAllocatorRef; locale: CFLocaleRef)
  ...
  'CFLocaleCreateCopy';
function CFLocaleGetIdentifier(locale: CFLocaleRef): CFLocaleIdentifier; cdecl;
  external libCoreFoundation name _PU + 'CFLocaleGetIdentifier';
function CFLocaleGetValue(locale: CFLocaleRef; key: CFLocaleKey): CFTypeRef;
...
function CFLocaleCopyDisplayNameForPropertyValue(displayLocale: CFLocaleRef;
  key: CFLocaleKey; value: CFStringRef): CFStringRef; cdecl;
  external libCoreFoundation name _PU +
...
function CFErrorCreate(allocator: CFAllocatorRef; domain: CFErrorDomain;
...
function CFErrorCreateWithUserInfoKeysAndValues(allocator: CFAllocatorRef;
  domain: CFErrorDomain; code: CFIndex; userInfoKeys: Pointer;
  userInfoValues: Pointer; numUserInfoValues: CFIndex): CFErrorRef; cdecl;
  external libCoreFoundation name _PU +
  'CFErrorCreateWithUserInfoKeysAndValues';
function CFErrorGetDomain(err: CFErrorRef): CFErrorDomain; cdecl;
...
function CFStringCreateWithCharacters(alloc: CFAllocatorRef; chars: PUniChar;
  numChars: CFIndex): CFStringRef; cdecl;
...
function CFStringCreateWithCharactersNoCopy(alloc: CFAllocatorRef;
  chars: PUniChar; numChars: CFIndex; contentsDeallocator: CFAllocatorRef)
  : CFStringRef; cdecl; external libCoreFoundation name _PU +
...
function CFStringCreateStringWithValidatedFormat(alloc: CFAllocatorRef;
  formatOptions: CFDictionaryRef; validFormatSpecifiers: CFStringRef;
  format: CFStringRef; errorPtr: PCFErrorRef): CFStringRef; cdecl;
  external libCoreFoundation name _PU +
  'CFStringCreateStringWithValidatedFormat';
function CFStringCreateStringWithValidatedFormatAndArguments
  (alloc: CFAllocatorRef; formatOptions: CFDictionaryRef;
  validFormatSpecifiers: CFStringRef; format: CFStringRef;
  arguments: array of const; errorPtr: PCFErrorRef): CFStringRef; cdecl;
  external libCoreFoundation name _PU +
...
procedure CFStringGetCharacters(theString: CFStringRef; range: CFRange;
  buffer: PUniChar); cdecl; external libCoreFoundation name _PU +
...
function CFStringGetCharactersPtr(theString: CFStringRef): PUniChar; cdecl;
  external libCoreFoundation name _PU + 'CFStringGetCharactersPtr';
...
function CFStringFindWithOptionsAndLocale(theString: CFStringRef;
  ...
  searchOptions: CFStringCompareFlags; locale: CFLocaleRef; result: PCFRange)
  : Boolean; cdecl; external libCoreFoundation name _PU +
...
procedure CFStringGetLineBounds(theString: CFStringRef; range: CFRange;
  lineBeginIndex: PCFIndex; lineEndIndex: PCFIndex; contentsEndIndex: PCFIndex);
...
procedure CFStringGetParagraphBounds(&string: CFStringRef; range: CFRange;
  parBeginIndex: PCFIndex; parEndIndex: PCFIndex; contentsEndIndex: PCFIndex);
...
function CFStringGetHyphenationLocationBeforeIndex(&string: CFStringRef;
  ...
  locale: CFLocaleRef; character: PUTF32Char): CFIndex; cdecl;
  external libCoreFoundation name _PU +
...
function CFStringGetCharacterFromInlineBuffer(buf: PCFStringInlineBuffer;
  ...
  external libCoreFoundation name _PU + 'CFStringGetCharacterFromInlineBuffer';
...
function CFStringGetSurrogatePairForLongCharacter(character: UTF32Char;
  surrogates: PUniChar): Boolean; cdecl;
  external libCoreFoundation name _PU +
...
function CFAttributedStringGetAttribute(aStr: CFAttributedStringRef;
  loc: CFIndex; attrName: CFStringRef; effectiveRange: PCFRange): CFTypeRef;
...
function CFURLCopyStrictPath(anURL: CFURLRef; isAbsolute: PBoolean)
  : CFStringRef; cdecl; external libCoreFoundation name _PU +
  'CFURLCopyStrictPath';
...
function CFURLGetByteRangeForComponent(url: CFURLRef;
  component: CFURLComponentType; rangeIncludingSeparators: PCFRange): CFRange;
...
function CFURLSetResourcePropertyForKey(url: CFURLRef; key: CFStringRef;
  propertyValue: CFTypeRef; error: PCFErrorRef): Boolean; cdecl;
...
function CFURLResourceIsReachable(url: CFURLRef; error: PCFErrorRef): Boolean;
...
function CFURLWriteBookmarkDataToFile(bookmarkRef: CFDataRef; fileURL: CFURLRef;
  options: CFURLBookmarkFileCreationOptions; errorRef: PCFErrorRef): Boolean;
  cdecl; external libCoreFoundation name _PU + 'CFURLWriteBookmarkDataToFile';
...
function CFBundlePreflightExecutable(bundle: CFBundleRef; error: PCFErrorRef)
  : Boolean; cdecl; external libCoreFoundation name _PU +
...
function CFBundleIsExecutableLoadable(bundle: CFBundleRef): Boolean; cdecl;
  external libCoreFoundation name _PU + 'CFBundleIsExecutableLoadable';
function CFBundleIsExecutableLoadableForURL(url: CFURLRef): Boolean; cdecl;
  external libCoreFoundation name _PU + 'CFBundleIsExecutableLoadableForURL';
function CFBundleIsArchitectureLoadable(arch: cpu_type_t): Boolean; cdecl;
  external libCoreFoundation name _PU + 'CFBundleIsArchitectureLoadable';
...
function CFBundleOpenBundleResourceFiles(bundle: CFBundleRef;
  refNum: PCFBundleRefNum; localizedRefNum: PCFBundleRefNum): Int32; cdecl;
...
function CFCalendarCreateWithIdentifier(allocator: CFAllocatorRef;
  identifier: CFCalendarIdentifier): CFCalendarRef; cdecl;
  external libCoreFoundation name _PU + 'CFCalendarCreateWithIdentifier';
function CFCalendarGetIdentifier(calendar: CFCalendarRef): CFCalendarIdentifier;
  cdecl; external libCoreFoundation name _PU + 'CFCalendarGetIdentifier';
...
function CFCalendarGetTimeRangeOfUnit(calendar: CFCalendarRef;
  ...
  external libCoreFoundation name _PU + 'CFCalendarGetTimeRangeOfUnit';
function CFCalendarComposeAbsoluteTime(calendar: CFCalendarRef;
  at: PCFAbsoluteTime; componentDesc: MarshaledAString): Boolean; cdecl;
...
function CFDateFormatterCreateISO8601Formatter(allocator: CFAllocatorRef;
  formatOptions: CFISO8601DateFormatOptions): CFDateFormatterRef; cdecl;
  external libCoreFoundation name _PU + 'CFDateFormatterCreateISO8601Formatter';
...
function CFDateFormatterCreateDateFromString(allocator: CFAllocatorRef;
  formatter: CFDateFormatterRef; &string: CFStringRef; rangep: PCFRange)
...
function CFDateFormatterCopyProperty(formatter: CFDateFormatterRef;
  key: CFDateFormatterKey): CFTypeRef; cdecl;
...
function CFRunLoopCopyCurrentMode(rl: CFRunLoopRef): CFRunLoopMode; cdecl;
...
procedure CFRunLoopAddCommonMode(rl: CFRunLoopRef; mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopAddCommonMode';
function CFRunLoopGetNextTimerFireDate(rl: CFRunLoopRef; mode: CFRunLoopMode)
...
function CFRunLoopRunInMode(mode: CFRunLoopMode; seconds: CFTimeInterval;
...
function CFRunLoopContainsSource(rl: CFRunLoopRef; source: CFRunLoopSourceRef;
  mode: CFRunLoopMode): Boolean; cdecl;
...
procedure CFRunLoopAddSource(rl: CFRunLoopRef; source: CFRunLoopSourceRef;
  mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopAddSource';
procedure CFRunLoopRemoveSource(rl: CFRunLoopRef; source: CFRunLoopSourceRef;
  mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopRemoveSource';
function CFRunLoopContainsObserver(rl: CFRunLoopRef;
  observer: CFRunLoopObserverRef; mode: CFRunLoopMode): Boolean; cdecl;
...
procedure CFRunLoopAddObserver(rl: CFRunLoopRef; observer: CFRunLoopObserverRef;
  mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopAddObserver';
procedure CFRunLoopRemoveObserver(rl: CFRunLoopRef;
  observer: CFRunLoopObserverRef; mode: CFRunLoopMode); cdecl;
...
procedure CFRunLoopAddTimer(rl: CFRunLoopRef; timer: CFRunLoopTimerRef;
  mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopAddTimer';
procedure CFRunLoopRemoveTimer(rl: CFRunLoopRef; timer: CFRunLoopTimerRef;
  mode: CFRunLoopMode); cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopRemoveTimer';
...
procedure CFRunLoopSourceGetContext(source: CFRunLoopSourceRef;
  ...
  external libCoreFoundation name _PU + 'CFRunLoopSourceGetContext';
...
function CFRunLoopObserverCreate(allocator: CFAllocatorRef;
  ...
  callout: CFRunLoopObserverCallBack; context: PCFRunLoopObserverContext)
  : CFRunLoopObserverRef; cdecl;
  external libCoreFoundation name _PU + 'CFRunLoopObserverCreate';
...
procedure CFRunLoopObserverGetContext(observer: CFRunLoopObserverRef;
  ...
  external libCoreFoundation name _PU + 'CFRunLoopObserverGetContext';
...
function CFRunLoopTimerCreate(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFRunLoopTimerCreate';
...
procedure CFRunLoopTimerGetContext(timer: CFRunLoopTimerRef;
  ...
  external libCoreFoundation name _PU + 'CFRunLoopTimerGetContext';
...
function CFFileDescriptorCreate(allocator: CFAllocatorRef;
  ...
  callout: CFFileDescriptorCallBack; context: PCFFileDescriptorContext)
  : CFFileDescriptorRef; cdecl;
  external libCoreFoundation name _PU + 'CFFileDescriptorCreate';
...
procedure CFFileDescriptorGetContext(f: CFFileDescriptorRef;
  context: PCFFileDescriptorContext); cdecl;
  external libCoreFoundation name _PU + 'CFFileDescriptorGetContext';
...
function CFFileSecurityCopyOwnerUUID(fileSec: CFFileSecurityRef;
  ownerUUID: PCFUUIDRef): Boolean; cdecl;
...
function CFFileSecurityCopyGroupUUID(fileSec: CFFileSecurityRef;
  groupUUID: PCFUUIDRef): Boolean; cdecl;
...
function CFFileSecurityGetMode(fileSec: CFFileSecurityRef; mode: PWord)
  : Boolean; cdecl; external libCoreFoundation name _PU +
...
function CFMachPortCreate(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFMachPortCreate';
...
procedure CFMachPortGetContext(port: CFMachPortRef;
  context: PCFMachPortContext); cdecl;
...
function CFMessagePortCreateLocal(allocator: CFAllocatorRef; name: CFStringRef;
  ...
  external libCoreFoundation name _PU + 'CFMessagePortCreateLocal';
...
procedure CFMessagePortGetContext(ms: CFMessagePortRef;
  ...
  external libCoreFoundation name _PU + 'CFMessagePortGetContext';
...
function CFMessagePortSendRequest(remote: CFMessagePortRef; msgid: Int32;
  ...
  replyMode: CFStringRef; returnData: PCFDataRef): Int32; cdecl;
...
procedure CFNumberFormatterSetProperty(formatter: CFNumberFormatterRef;
  key: CFNumberFormatterKey; value: CFTypeRef); cdecl;
...
function CFPreferencesGetAppBooleanValue(key: CFStringRef;
  applicationID: CFStringRef; keyExistsAndHasValidFormat: PBoolean): Boolean;
  cdecl; external libCoreFoundation name _PU +
  'CFPreferencesGetAppBooleanValue';
function CFPreferencesGetAppIntegerValue(key: CFStringRef;
  applicationID: CFStringRef; keyExistsAndHasValidFormat: PBoolean): CFIndex;
  cdecl; external libCoreFoundation name _PU +
...
function CFSocketCreateConnectedToSocketSignature(allocator: CFAllocatorRef;
  signature: PCFSocketSignature; callBackTypes: CFOptionFlags;
  callout: CFSocketCallBack; context: PCFSocketContext; timeout: CFTimeInterval)
  : CFSocketRef; cdecl; external libCoreFoundation name _PU +
...
function CFSocketCopyRegisteredValue(nameServerSignature: PCFSocketSignature;
  timeout: CFTimeInterval; name: CFStringRef; value: PCFPropertyListRef;
  nameServerAddress: PCFDataRef): CFSocketError; cdecl;
  external libCoreFoundation name _PU + 'CFSocketCopyRegisteredValue';
function CFSocketRegisterSocketSignature(nameServerSignature
  : PCFSocketSignature; timeout: CFTimeInterval; name: CFStringRef;
  signature: PCFSocketSignature): CFSocketError; cdecl;
  external libCoreFoundation name _PU + 'CFSocketRegisterSocketSignature';
function CFSocketCopyRegisteredSocketSignature(nameServerSignature
  : PCFSocketSignature; timeout: CFTimeInterval; name: CFStringRef;
  signature: PCFSocketSignature; nameServerAddress: PCFDataRef): CFSocketError;
  cdecl; external libCoreFoundation name _PU +
...
procedure CFStreamCreateBoundPair(alloc: CFAllocatorRef;
  readStream: PCFReadStreamRef; writeStream: PCFWriteStreamRef;
...
procedure CFStreamCreatePairWithSocketToHost(alloc: CFAllocatorRef;
  ...
  writeStream: PCFWriteStreamRef); cdecl;
  external libCoreFoundation name _PU + 'CFStreamCreatePairWithSocketToHost';
...
function CFReadStreamGetBuffer(stream: CFReadStreamRef; maxBytesToRead: CFIndex;
  numBytesRead: PCFIndex): PByte; cdecl;
...
function CFReadStreamCopyProperty(stream: CFReadStreamRef;
  propertyName: CFStreamPropertyKey): CFTypeRef; cdecl;
...
function CFReadStreamSetProperty(stream: CFReadStreamRef;
  propertyName: CFStreamPropertyKey; propertyValue: CFTypeRef): Boolean; cdecl;
...
procedure CFReadStreamScheduleWithRunLoop(stream: CFReadStreamRef;
  runLoop: CFRunLoopRef; runLoopMode: CFRunLoopMode); cdecl;
...
function CFPropertyListCreateFromXMLData(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFPropertyListCreateFromXMLData';
...
function CFPropertyListWriteToStream(propertyList: CFPropertyListRef;
  ...
  external libCoreFoundation name _PU + 'CFPropertyListWriteToStream';
function CFPropertyListCreateFromStream(allocator: CFAllocatorRef;
  ...
  errorString: PCFStringRef): CFPropertyListRef; cdecl;
  external libCoreFoundation name _PU + 'CFPropertyListCreateFromStream';
function CFPropertyListCreateWithData(allocator: CFAllocatorRef;
  ...
  external libCoreFoundation name _PU + 'CFPropertyListCreateWithData';
...
function CFStringTokenizerGetCurrentSubTokens(tokenizer: CFStringTokenizerRef;
  ...
  external libCoreFoundation name _PU + 'CFStringTokenizerGetCurrentSubTokens';
function CFTreeGetTypeID: CFTypeID; cdecl;
  external libCoreFoundation name _PU + 'CFTreeGetTypeID';
function CFTreeCreate(allocator: CFAllocatorRef; context: PCFTreeContext)
  : CFTreeRef; cdecl; external libCoreFoundation name _PU + 'CFTreeCreate';
...
procedure CFTreeGetContext(tree: CFTreeRef; context: PCFTreeContext); cdecl;
...
procedure CFTreeGetChildren(tree: CFTreeRef; children: PCFTreeRef); cdecl;
...
procedure CFTreeSetContext(tree: CFTreeRef; context: PCFTreeContext); cdecl;
...
function CFUserNotificationGetTypeID: CFTypeID; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationGetTypeID';
function CFUserNotificationCreate(allocator: CFAllocatorRef;
  timeout: CFTimeInterval; flags: CFOptionFlags; error: PLongInt;
  dictionary: CFDictionaryRef): CFUserNotificationRef; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationCreate';
function CFUserNotificationReceiveResponse(userNotification
  : CFUserNotificationRef; timeout: CFTimeInterval;
  responseFlags: PCFOptionFlags): Int32; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationReceiveResponse';
function CFUserNotificationGetResponseValue(userNotification
  : CFUserNotificationRef; key: CFStringRef; idx: CFIndex): CFStringRef; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationGetResponseValue';
function CFUserNotificationGetResponseDictionary(userNotification
  : CFUserNotificationRef): CFDictionaryRef; cdecl;
  external libCoreFoundation name _PU +
  'CFUserNotificationGetResponseDictionary';
function CFUserNotificationUpdate(userNotification: CFUserNotificationRef;
  timeout: CFTimeInterval; flags: CFOptionFlags; dictionary: CFDictionaryRef)
  : Int32; cdecl; external libCoreFoundation name _PU +
  'CFUserNotificationUpdate';
function CFUserNotificationCancel(userNotification: CFUserNotificationRef)
  : Int32; cdecl; external libCoreFoundation name _PU +
...
function CFUserNotificationCreateRunLoopSource(allocator: CFAllocatorRef;
  ...
  order: CFIndex): CFRunLoopSourceRef; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationCreateRunLoopSource';
function CFUserNotificationDisplayNotice(timeout: CFTimeInterval;
  ...
  alertMessage: CFStringRef; defaultButtonTitle: CFStringRef): Int32; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationDisplayNotice';
function CFUserNotificationDisplayAlert(timeout: CFTimeInterval;
  ...
  responseFlags: PCFOptionFlags): Int32; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationDisplayAlert';
function CFUserNotificationCheckBoxChecked(i: CFIndex): CFOptionFlags; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationCheckBoxChecked';
function CFUserNotificationSecureTextField(i: CFIndex): CFOptionFlags; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationSecureTextField';
function CFUserNotificationPopUpSelection(n: CFIndex): CFOptionFlags; cdecl;
  external libCoreFoundation name _PU + 'CFUserNotificationPopUpSelection';
...
function kCFErrorLocalizedFailureKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFErrorLocalizedFailureKey');
end;
...
function kCFURLFileIdentifierKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLFileIdentifierKey');
end;
...
function kCFURLIsPurgeableKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLIsPurgeableKey');
end;

function kCFURLIsSparseKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLIsSparseKey');
end;
...
function kCFURLCanonicalPathKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLCanonicalPathKey');
end;
...
function kCFURLVolumeIsEncryptedKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLVolumeIsEncryptedKey');
end;
...
function kCFURLVolumeTypeNameKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLVolumeTypeNameKey');
end;

function kCFURLVolumeSubtypeKey: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFURLVolumeSubtypeKey');
end;
...
function kCFStreamErrorDomainSOCKS: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFStreamErrorDomainSOCKS');
end;

function kCFStreamPropertySOCKSProxy: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFStreamPropertySOCKSProxy');
end;
...
function kCFStreamPropertySOCKSUser: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFStreamPropertySOCKSUser');
end;
...
function kCFStreamErrorDomainSSL: Pointer;
begin
  result := CocoaPointerConst(libCoreFoundation, 'kCFStreamErrorDomainSSL');
end;
