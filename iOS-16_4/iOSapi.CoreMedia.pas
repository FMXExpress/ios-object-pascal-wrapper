...
{$M+}
  ...
  CMBaseClassVersion = uintptr_t;
  PCMBaseClassVersion = ^CMBaseClassVersion;
  CMStructVersion = uintptr_t;
  PCMStructVersion = ^CMStructVersion;
  CMPersistentTrackID = Int32;
  PCMPersistentTrackID = ^CMPersistentTrackID;
  CFTypeRef = Pointer;
  PCFTypeRef = ^CFTypeRef;
  CMAttachmentBearerRef = CFTypeRef;
  PCMAttachmentBearerRef = ^CMAttachmentBearerRef;
  ...
  PCMClockOrTimebaseRef = ^CMClockOrTimebaseRef;
  CFTypeID = LongWord;
  PCFTypeID = ^CFTypeID;
  ...
  PCMBlockBufferFlags = ^CMBlockBufferFlags;
  ...
  PCMBufferRef = ^CMBufferRef;
  CMBufferGetTimeCallback = function(param1: CMBufferRef; param2: Pointer)
    : CMTime; cdecl;
  PCMBufferGetTimeCallback = ^CMBufferGetTimeCallback;
  CMBufferGetTimeHandler = function(param1: CMBufferRef): CMTime; cdecl;
  CMBufferGetBooleanCallback = function(param1: CMBufferRef; param2: Pointer)
    : Boolean; cdecl;
  PCMBufferGetBooleanCallback = ^CMBufferGetBooleanCallback;
  CMBufferGetBooleanHandler = function(param1: CMBufferRef): Boolean; cdecl;
  ...
  PCMBufferCompareCallback = ^CMBufferCompareCallback;
  CMBufferCompareHandler = function(param1: CMBufferRef; param2: CMBufferRef)
    : CFComparisonResult; cdecl;
  CMBufferGetSizeCallback = function(param1: CMBufferRef; param2: Pointer)
    : LongWord; cdecl;
  PCMBufferGetSizeCallback = ^CMBufferGetSizeCallback;
  CMBufferGetSizeHandler = function(param1: CMBufferRef): LongWord; cdecl;
  ...
  PCMBufferHandlers = ^CMBufferHandlers;
  ...
  PCMBufferQueueTriggerCallback = ^CMBufferQueueTriggerCallback;
  CMBufferQueueTriggerHandler = procedure(param1: CMBufferQueueTriggerToken)
    of object;
  CMBufferQueueTriggerCondition = Int32;
  PCMBufferQueueTriggerCondition = ^CMBufferQueueTriggerCondition;
  ...
  PCMBufferValidationCallback = ^CMBufferValidationCallback;
  CMBufferValidationHandler = function(param1: CMBufferQueueRef;
    param2: CMBufferRef): OSStatus; cdecl;
  ...
  PCMAudioCodecType = ^CMAudioCodecType;
  ...
  PCMPixelFormatType = ^CMPixelFormatType;
  ...
  PCMMuxedStreamType = ^CMMuxedStreamType;
  CMClosedCaptionFormatDescriptionRef = CMFormatDescriptionRef;
  PCMClosedCaptionFormatDescriptionRef = ^CMClosedCaptionFormatDescriptionRef;
  CMClosedCaptionFormatType = FourCharCode;
  PCMClosedCaptionFormatType = ^CMClosedCaptionFormatType;
  CMTextFormatDescriptionRef = CMFormatDescriptionRef;
  PCMTextFormatDescriptionRef = ^CMTextFormatDescriptionRef;
  CMTextFormatType = FourCharCode;
  PCMTextFormatType = ^CMTextFormatType;
  ...
  PCMSubtitleFormatType = ^CMSubtitleFormatType;
  ...
  PCMTimeCodeFormatType = ^CMTimeCodeFormatType;
  ...
  PCMMetadataFormatType = ^CMMetadataFormatType;
  OSType = FourCharCode;
  POSType = ^OSType;
  CMImageDescriptionFlavor = CFStringRef;
  PCMImageDescriptionFlavor = ^CMImageDescriptionFlavor;
  CFStringEncoding = UInt32;
  PCFStringEncoding = ^CFStringEncoding;
  CMSoundDescriptionFlavor = CFStringRef;
  PCMSoundDescriptionFlavor = ^CMSoundDescriptionFlavor;
  CMTextDescriptionFlavor = CFStringRef;
  PCMTextDescriptionFlavor = ^CMTextDescriptionFlavor;
  CMClosedCaptionDescriptionFlavor = CFStringRef;
  PCMClosedCaptionDescriptionFlavor = ^CMClosedCaptionDescriptionFlavor;
  CMTimeCodeDescriptionFlavor = CFStringRef;
  PCMTimeCodeDescriptionFlavor = ^CMTimeCodeDescriptionFlavor;
  CMMetadataDescriptionFlavor = CFStringRef;
  PCMMetadataDescriptionFlavor = ^CMMetadataDescriptionFlavor;
  CMMemoryPoolRef = Pointer;
  PCMMemoryPoolRef = ^CMMemoryPoolRef;
  ...
  CMSampleBufferMakeDataReadyCallback = function(param1: CMSampleBufferRef;
    param2: Pointer): OSStatus; cdecl;
  PCMSampleBufferMakeDataReadyCallback = ^CMSampleBufferMakeDataReadyCallback;
  CMSampleBufferMakeDataReadyHandler = function(param1: CMSampleBufferRef)
    : OSStatus; cdecl;
  ...
  CMSampleBufferInvalidateCallback = procedure(param1: CMSampleBufferRef;
    param2: UInt64); cdecl;
  PCMSampleBufferInvalidateCallback = ^CMSampleBufferInvalidateCallback;
  CMSampleBufferInvalidateHandler = procedure(param1: CMSampleBufferRef)
    of object;
  TCoreMediaCallback2 = function(param1: CMSampleBufferRef; param2: CMItemCount;
    param3: Pointer): OSStatus; cdecl;
  TCoreMediaHandler = function(param1: CMSampleBufferRef; param2: CMItemCount)
    : OSStatus; cdecl;
...
function kCMFormatDescriptionTransferFunction_SMPTE_ST_428_1: Pointer;
function kCMFormatDescriptionTransferFunction_SMPTE_ST_2084_PQ: Pointer;
function kCMFormatDescriptionTransferFunction_ITU_R_2100_HLG: Pointer;
function kCMFormatDescriptionTransferFunction_Linear: Pointer;
function kCMFormatDescriptionTransferFunction_sRGB: Pointer;
...
function kCMFormatDescriptionExtension_ProtectedContentOriginalFormat: Pointer;
...
function kCMFormatDescriptionExtension_MasteringDisplayColorVolume: Pointer;
function kCMFormatDescriptionExtension_ContentLightLevelInfo: Pointer;
function kCMFormatDescriptionExtension_AlternativeTransferCharacteristics
  : Pointer;
function kCMFormatDescriptionExtension_AuxiliaryTypeInfo: Pointer;
function kCMFormatDescriptionExtension_AlphaChannelMode: Pointer;
function kCMFormatDescriptionAlphaChannelMode_StraightAlpha: Pointer;
function kCMFormatDescriptionAlphaChannelMode_PremultipliedAlpha: Pointer;
function kCMFormatDescriptionExtension_ContainsAlphaChannel: Pointer;
function kCMFormatDescriptionExtension_BitsPerComponent: Pointer;
function kCMFormatDescriptionExtension_HorizontalFieldOfView: Pointer;
...
function kCMFormatDescriptionExtension_AmbientViewingEnvironment: Pointer;
...
function kCMMetadataFormatDescriptionKey_SetupData: Pointer;
...
function kCMMetadataFormatDescriptionMetadataSpecificationKey_StructuralDependency
  : Pointer;
function kCMMetadataFormatDescriptionMetadataSpecificationKey_SetupData
  : Pointer;
...
function kCMImageDescriptionFlavor_ISOFamilyWithAppleExtensions: Pointer;
...
function kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransform
  : Pointer;
function kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransformReferenceDimensions
  : Pointer;
...
function kCMMetadataBaseDataType_PerspectiveTransformF64: Pointer;
...
function kCMSampleAttachmentKey_HEVCTemporalLevelInfo: Pointer;
function kCMHEVCTemporalLevelInfoKey_TemporalLevel: Pointer;
function kCMHEVCTemporalLevelInfoKey_ProfileSpace: Pointer;
function kCMHEVCTemporalLevelInfoKey_TierFlag: Pointer;
function kCMHEVCTemporalLevelInfoKey_ProfileIndex: Pointer;
function kCMHEVCTemporalLevelInfoKey_ProfileCompatibilityFlags: Pointer;
function kCMHEVCTemporalLevelInfoKey_ConstraintIndicatorFlags: Pointer;
function kCMHEVCTemporalLevelInfoKey_LevelIndex: Pointer;
function kCMSampleAttachmentKey_HEVCTemporalSubLayerAccess: Pointer;
function kCMSampleAttachmentKey_HEVCStepwiseTemporalSubLayerAccess: Pointer;
function kCMSampleAttachmentKey_HEVCSyncSampleNALUnitType: Pointer;
function kCMSampleAttachmentKey_AudioIndependentSampleDecoderRefreshCount
  : Pointer;
...
function kCMSampleBufferAttachmentKey_CameraIntrinsicMatrix: Pointer;
function kCMSampleBufferAttachmentKey_ForceKeyFrame: Pointer;
function kCMSampleAttachmentKey_CryptorSubsampleAuxiliaryData: Pointer;
function kCMSampleAttachmentKey_HDR10PlusPerFrameData: Pointer;
...
function kCMTextMarkupAttribute_FontFamilyNameList: Pointer;
...
procedure CMSetAttachment(target: CMAttachmentBearerRef; key: CFStringRef;
  value: CFTypeRef; attachmentMode: CMAttachmentMode); cdecl;
  external libCoreMedia name _PU + 'CMSetAttachment';
function CMGetAttachment(target: CMAttachmentBearerRef; key: CFStringRef;
  attachmentModeOut: PCMAttachmentMode): CFTypeRef; cdecl;
  external libCoreMedia name _PU + 'CMGetAttachment';
procedure CMRemoveAttachment(target: CMAttachmentBearerRef; key: CFStringRef);
  cdecl; external libCoreMedia name _PU + 'CMRemoveAttachment';
procedure CMRemoveAllAttachments(target: CMAttachmentBearerRef); cdecl;
  external libCoreMedia name _PU + 'CMRemoveAllAttachments';
function CMCopyDictionaryOfAttachments(allocator: CFAllocatorRef;
  target: CMAttachmentBearerRef; attachmentMode: CMAttachmentMode)
  : CFDictionaryRef; cdecl;
  external libCoreMedia name _PU + 'CMCopyDictionaryOfAttachments';
procedure CMSetAttachments(target: CMAttachmentBearerRef;
  theAttachments: CFDictionaryRef; attachmentMode: CMAttachmentMode); cdecl;
  external libCoreMedia name _PU + 'CMSetAttachments';
procedure CMPropagateAttachments(source: CMAttachmentBearerRef;
  destination: CMAttachmentBearerRef); cdecl;
  external libCoreMedia name _PU + 'CMPropagateAttachments';
function CMTimeMake(value: Int64; timescale: Int32): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMake';
function CMTimeMakeWithEpoch(value: Int64; timescale: Int32; epoch: Int64)
  : CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMakeWithEpoch';
function CMTimeMakeWithSeconds(seconds: Double; preferredTimescale: Int32)
  : CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMakeWithSeconds';
function CMTimeGetSeconds(time: CMTime): Double; cdecl;
  external libCoreMedia name _PU + 'CMTimeGetSeconds';
function CMTimeConvertScale(time: CMTime; newTimescale: Int32;
  method: CMTimeRoundingMethod): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeConvertScale';
function CMTimeAdd(lhs: CMTime; rhs: CMTime): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeAdd';
function CMTimeSubtract(lhs: CMTime; rhs: CMTime): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeSubtract';
function CMTimeMultiply(time: CMTime; multiplier: Int32): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMultiply';
function CMTimeMultiplyByFloat64(time: CMTime; multiplier: Double): CMTime;
  cdecl; external libCoreMedia name _PU + 'CMTimeMultiplyByFloat64';
function CMTimeMultiplyByRatio(time: CMTime; multiplier: Int32; divisor: Int32)
  : CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMultiplyByRatio';
function CMTimeCompare(time1: CMTime; time2: CMTime): Int32; cdecl;
  external libCoreMedia name _PU + 'CMTimeCompare';
function CMTimeMinimum(time1: CMTime; time2: CMTime): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMinimum';
function CMTimeMaximum(time1: CMTime; time2: CMTime): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMaximum';
function CMTimeAbsoluteValue(time: CMTime): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeAbsoluteValue';
function CMTimeCopyAsDictionary(time: CMTime; allocator: CFAllocatorRef)
  : CFDictionaryRef; cdecl;
  external libCoreMedia name _PU + 'CMTimeCopyAsDictionary';
function CMTimeMakeFromDictionary(dictionaryRepresentation: CFDictionaryRef)
  : CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMakeFromDictionary';
function CMTimeCopyDescription(allocator: CFAllocatorRef; time: CMTime)
  : CFStringRef; cdecl; external libCoreMedia name _PU +
  'CMTimeCopyDescription';
procedure CMTimeShow(time: CMTime); cdecl;
  external libCoreMedia name _PU + 'CMTimeShow';
function CMClockGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMClockGetTypeID';
function CMClockGetHostTimeClock: CMClockRef; cdecl;
  external libCoreMedia name _PU + 'CMClockGetHostTimeClock';
function CMClockConvertHostTimeToSystemUnits(hostTime: CMTime): UInt64; cdecl;
  external libCoreMedia name _PU + 'CMClockConvertHostTimeToSystemUnits';
function CMClockMakeHostTimeFromSystemUnits(hostTime: UInt64): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMClockMakeHostTimeFromSystemUnits';
function CMClockGetTime(clock: CMClockRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMClockGetTime';
function CMClockGetAnchorTime(clock: CMClockRef; clockTimeOut: PCMTime;
  referenceClockTimeOut: PCMTime): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMClockGetAnchorTime';
function CMClockMightDrift(clock: CMClockRef; otherClock: CMClockRef): Boolean;
  cdecl; external libCoreMedia name _PU + 'CMClockMightDrift';
procedure CMClockInvalidate(clock: CMClockRef); cdecl;
  external libCoreMedia name _PU + 'CMClockInvalidate';
function CMTimebaseGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetTypeID';
function CMTimebaseCreateWithMasterClock(allocator: CFAllocatorRef;
  masterClock: CMClockRef; timebaseOut: PCMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCreateWithMasterClock';
function CMTimebaseCreateWithSourceClock(allocator: CFAllocatorRef;
  sourceClock: CMClockRef; timebaseOut: PCMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCreateWithSourceClock';
function CMTimebaseCreateWithMasterTimebase(allocator: CFAllocatorRef;
  masterTimebase: CMTimebaseRef; timebaseOut: PCMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCreateWithMasterTimebase';
function CMTimebaseCreateWithSourceTimebase(allocator: CFAllocatorRef;
  sourceTimebase: CMTimebaseRef; timebaseOut: PCMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCreateWithSourceTimebase';
function CMTimebaseCopyMasterTimebase(timebase: CMTimebaseRef): CMTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopyMasterTimebase';
function CMTimebaseCopySourceTimebase(timebase: CMTimebaseRef): CMTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopySourceTimebase';
function CMTimebaseCopyMasterClock(timebase: CMTimebaseRef): CMClockRef; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCopyMasterClock';
function CMTimebaseCopySourceClock(timebase: CMTimebaseRef): CMClockRef; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseCopySourceClock';
function CMTimebaseCopyMaster(timebase: CMTimebaseRef): CMClockOrTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopyMaster';
function CMTimebaseCopySource(timebase: CMTimebaseRef): CMClockOrTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopySource';
function CMTimebaseCopyUltimateMasterClock(timebase: CMTimebaseRef): CMClockRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopyUltimateMasterClock';
function CMTimebaseCopyUltimateSourceClock(timebase: CMTimebaseRef): CMClockRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseCopyUltimateSourceClock';
function CMTimebaseGetMasterTimebase(timebase: CMTimebaseRef): CMTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseGetMasterTimebase';
function CMTimebaseGetMasterClock(timebase: CMTimebaseRef): CMClockRef; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetMasterClock';
function CMTimebaseGetMaster(timebase: CMTimebaseRef): CMClockOrTimebaseRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseGetMaster';
function CMTimebaseGetUltimateMasterClock(timebase: CMTimebaseRef): CMClockRef;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseGetUltimateMasterClock';
function CMTimebaseSetMasterClock(timebase: CMTimebaseRef;
  newMasterClock: CMClockRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetMasterClock';
function CMTimebaseSetSourceClock(timebase: CMTimebaseRef;
  newSourceClock: CMClockRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetSourceClock';
function CMTimebaseSetMasterTimebase(timebase: CMTimebaseRef;
  newMasterTimebase: CMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetMasterTimebase';
function CMTimebaseSetSourceTimebase(timebase: CMTimebaseRef;
  newSourceTimebase: CMTimebaseRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetSourceTimebase';
function CMTimebaseGetTime(timebase: CMTimebaseRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetTime';
function CMTimebaseGetTimeWithTimeScale(timebase: CMTimebaseRef;
  timescale: CMTimeScale; method: CMTimeRoundingMethod): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetTimeWithTimeScale';
function CMTimebaseSetTime(timebase: CMTimebaseRef; time: CMTime): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseSetTime';
function CMTimebaseSetAnchorTime(timebase: CMTimebaseRef; timebaseTime: CMTime;
  immediateSourceTime: CMTime): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetAnchorTime';
function CMTimebaseGetRate(timebase: CMTimebaseRef): Double; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetRate';
function CMTimebaseGetTimeAndRate(timebase: CMTimebaseRef; timeOut: PCMTime;
  rateOut: PDouble): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetTimeAndRate';
function CMTimebaseSetRate(timebase: CMTimebaseRef; rate: Double): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseSetRate';
function CMTimebaseSetRateAndAnchorTime(timebase: CMTimebaseRef; rate: Double;
  timebaseTime: CMTime; immediateSourceTime: CMTime): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetRateAndAnchorTime';
function CMTimebaseGetEffectiveRate(timebase: CMTimebaseRef): Double; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseGetEffectiveRate';
function CMTimebaseAddTimer(timebase: CMTimebaseRef; timer: CFRunLoopTimerRef;
  runloop: CFRunLoopRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseAddTimer';
function CMTimebaseRemoveTimer(timebase: CMTimebaseRef;
  timer: CFRunLoopTimerRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseRemoveTimer';
function CMTimebaseSetTimerNextFireTime(timebase: CMTimebaseRef;
  timer: CFRunLoopTimerRef; fireTime: CMTime; flags: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetTimerNextFireTime';
function CMTimebaseSetTimerToFireImmediately(timebase: CMTimebaseRef;
  timer: CFRunLoopTimerRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseSetTimerToFireImmediately';
function CMTimebaseAddTimerDispatchSource(timebase: CMTimebaseRef;
  timerSource: Pointer { dispatch_source_t } ): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseAddTimerDispatchSource';
function CMTimebaseRemoveTimerDispatchSource(timebase: CMTimebaseRef;
  timerSource: Pointer { dispatch_source_t } ): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimebaseRemoveTimerDispatchSource';
function CMTimebaseSetTimerDispatchSourceNextFireTime(timebase: CMTimebaseRef;
  timerSource: Pointer { dispatch_source_t }; fireTime: CMTime; flags: LongWord)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMTimebaseSetTimerDispatchSourceNextFireTime';
function CMTimebaseSetTimerDispatchSourceToFireImmediately
  (timebase: CMTimebaseRef; timerSource: Pointer { dispatch_source_t } )
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMTimebaseSetTimerDispatchSourceToFireImmediately';
function CMSyncGetRelativeRate(ofClockOrTimebase: CMClockOrTimebaseRef;
  relativeToClockOrTimebase: CMClockOrTimebaseRef): Double; cdecl;
  external libCoreMedia name _PU + 'CMSyncGetRelativeRate';
function CMSyncGetRelativeRateAndAnchorTime(ofClockOrTimebase
  : CMClockOrTimebaseRef; relativeToClockOrTimebase: CMClockOrTimebaseRef;
  outRelativeRate: PDouble; outOfClockOrTimebaseAnchorTime: PCMTime;
  outRelativeToClockOrTimebaseAnchorTime: PCMTime): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSyncGetRelativeRateAndAnchorTime';
function CMSyncConvertTime(time: CMTime;
  fromClockOrTimebase: CMClockOrTimebaseRef;
  toClockOrTimebase: CMClockOrTimebaseRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMSyncConvertTime';
function CMSyncMightDrift(clockOrTimebase1: CMClockOrTimebaseRef;
  clockOrTimebase2: CMClockOrTimebaseRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMSyncMightDrift';
function CMSyncGetTime(clockOrTimebase: CMClockOrTimebaseRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMSyncGetTime';
function CMTimebaseNotificationBarrier(timebase: CMTimebaseRef): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMTimebaseNotificationBarrier';
function CMAudioClockCreate(allocator: CFAllocatorRef; clockOut: PCMClockRef)
  : OSStatus; cdecl; external libCoreMedia name _PU + 'CMAudioClockCreate';
function CMBlockBufferCreateEmpty(structureAllocator: CFAllocatorRef;
  subBlockCapacity: LongWord; flags: CMBlockBufferFlags;
  blockBufferOut: PCMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferCreateEmpty';
function CMBlockBufferCreateWithMemoryBlock(structureAllocator: CFAllocatorRef;
  memoryBlock: Pointer; blockLength: LongWord; blockAllocator: CFAllocatorRef;
  customBlockSource: PCMBlockBufferCustomBlockSource; offsetToData: LongWord;
  dataLength: LongWord; flags: CMBlockBufferFlags;
  blockBufferOut: PCMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferCreateWithMemoryBlock';
function CMBlockBufferCreateWithBufferReference(structureAllocator
  : CFAllocatorRef; bufferReference: CMBlockBufferRef; offsetToData: LongWord;
  dataLength: LongWord; flags: CMBlockBufferFlags;
  blockBufferOut: PCMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferCreateWithBufferReference';
function CMBlockBufferCreateContiguous(structureAllocator: CFAllocatorRef;
  sourceBuffer: CMBlockBufferRef; blockAllocator: CFAllocatorRef;
  customBlockSource: PCMBlockBufferCustomBlockSource; offsetToData: LongWord;
  dataLength: LongWord; flags: CMBlockBufferFlags;
  blockBufferOut: PCMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferCreateContiguous';
function CMBlockBufferGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferGetTypeID';
function CMBlockBufferAppendMemoryBlock(theBuffer: CMBlockBufferRef;
  memoryBlock: Pointer; blockLength: LongWord; blockAllocator: CFAllocatorRef;
  customBlockSource: PCMBlockBufferCustomBlockSource; offsetToData: LongWord;
  dataLength: LongWord; flags: CMBlockBufferFlags): OSStatus; cdecl;
...
function CMBlockBufferAppendBufferReference(theBuffer: CMBlockBufferRef;
  targetBBuf: CMBlockBufferRef; offsetToData: LongWord; dataLength: LongWord;
  flags: CMBlockBufferFlags): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferAppendBufferReference';
function CMBlockBufferAssureBlockMemory(theBuffer: CMBlockBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMBlockBufferAssureBlockMemory';
function CMBlockBufferAccessDataBytes(theBuffer: CMBlockBufferRef;
  offset: LongWord; length: LongWord; temporaryBlock: Pointer;
  returnedPointerOut: MarshaledAString): OSStatus; cdecl;
...
function CMBlockBufferCopyDataBytes(theSourceBuffer: CMBlockBufferRef;
  offsetToData: LongWord; dataLength: LongWord; destination: Pointer): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMBlockBufferCopyDataBytes';
function CMBlockBufferReplaceDataBytes(sourceBytes: Pointer;
  destinationBuffer: CMBlockBufferRef; offsetIntoDestination: LongWord;
  dataLength: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferReplaceDataBytes';
function CMBlockBufferFillDataBytes(fillByte: Byte;
  destinationBuffer: CMBlockBufferRef; offsetIntoDestination: LongWord;
  dataLength: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferFillDataBytes';
function CMBlockBufferGetDataPointer(theBuffer: CMBlockBufferRef;
  offset: LongWord; lengthAtOffsetOut: PLongWord; totalLengthOut: PLongWord;
  dataPointerOut: MarshaledAString): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferGetDataPointer';
function CMBlockBufferGetDataLength(theBuffer: CMBlockBufferRef): LongWord;
  cdecl; external libCoreMedia name _PU + 'CMBlockBufferGetDataLength';
function CMBlockBufferIsRangeContiguous(theBuffer: CMBlockBufferRef;
  offset: LongWord; length: LongWord): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferIsRangeContiguous';
function CMBlockBufferIsEmpty(theBuffer: CMBlockBufferRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMBlockBufferIsEmpty';
function CMBufferQueueGetCallbacksForUnsortedSampleBuffers: PCMBufferCallbacks;
...
function CMBufferQueueGetCallbacksForSampleBuffersSortedByOutputPTS
  : PCMBufferCallbacks; cdecl;
  external libCoreMedia name _PU +
  'CMBufferQueueGetCallbacksForSampleBuffersSortedByOutputPTS';
function CMBufferQueueCreate(allocator: CFAllocatorRef; capacity: CMItemCount;
  callbacks: PCMBufferCallbacks; queueOut: PCMBufferQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueCreate';
function CMBufferQueueCreateWithHandlers(allocator: CFAllocatorRef;
  capacity: CMItemCount; handlers: PCMBufferHandlers;
  queueOut: PCMBufferQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueCreateWithHandlers';
function CMBufferQueueGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueGetTypeID';
function CMBufferQueueEnqueue(queue: CMBufferQueueRef; buf: CMBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU + 'CMBufferQueueEnqueue';
function CMBufferQueueDequeueAndRetain(queue: CMBufferQueueRef): CMBufferRef;
  cdecl; external libCoreMedia name _PU + 'CMBufferQueueDequeueAndRetain';
function CMBufferQueueDequeueIfDataReadyAndRetain(queue: CMBufferQueueRef)
  : CMBufferRef; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueDequeueIfDataReadyAndRetain';
function CMBufferQueueGetHead(queue: CMBufferQueueRef): CMBufferRef; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueGetHead';
function CMBufferQueueIsEmpty(queue: CMBufferQueueRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueIsEmpty';
function CMBufferQueueMarkEndOfData(queue: CMBufferQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueMarkEndOfData';
function CMBufferQueueContainsEndOfData(queue: CMBufferQueueRef): Boolean;
  cdecl; external libCoreMedia name _PU + 'CMBufferQueueContainsEndOfData';
function CMBufferQueueIsAtEndOfData(queue: CMBufferQueueRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueIsAtEndOfData';
function CMBufferQueueReset(queue: CMBufferQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueReset';
function CMBufferQueueResetWithCallback(queue: CMBufferQueueRef;
  callback: TCoreMediaCallback; refCon: Pointer): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueResetWithCallback';
function CMBufferQueueGetBufferCount(queue: CMBufferQueueRef): CMItemCount;
  cdecl; external libCoreMedia name _PU + 'CMBufferQueueGetBufferCount';
function CMBufferQueueGetDuration(queue: CMBufferQueueRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueGetDuration';
function CMBufferQueueGetMinDecodeTimeStamp(queue: CMBufferQueueRef): CMTime;
  cdecl; external libCoreMedia name _PU + 'CMBufferQueueGetMinDecodeTimeStamp';
function CMBufferQueueGetFirstDecodeTimeStamp(queue: CMBufferQueueRef): CMTime;
  cdecl; external libCoreMedia name _PU +
  'CMBufferQueueGetFirstDecodeTimeStamp';
function CMBufferQueueGetMinPresentationTimeStamp(queue: CMBufferQueueRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueGetMinPresentationTimeStamp';
function CMBufferQueueGetFirstPresentationTimeStamp(queue: CMBufferQueueRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueGetFirstPresentationTimeStamp';
function CMBufferQueueGetMaxPresentationTimeStamp(queue: CMBufferQueueRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueGetMaxPresentationTimeStamp';
function CMBufferQueueGetEndPresentationTimeStamp(queue: CMBufferQueueRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueGetEndPresentationTimeStamp';
function CMBufferQueueGetTotalSize(queue: CMBufferQueueRef): LongWord; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueGetTotalSize';
function CMBufferQueueInstallTrigger(queue: CMBufferQueueRef;
  callback: CMBufferQueueTriggerCallback; refCon: Pointer;
  condition: CMBufferQueueTriggerCondition; time: CMTime;
  triggerTokenOut: PCMBufferQueueTriggerToken): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueInstallTrigger';
function CMBufferQueueInstallTriggerWithIntegerThreshold
  (queue: CMBufferQueueRef; callback: CMBufferQueueTriggerCallback;
  refCon: Pointer; condition: CMBufferQueueTriggerCondition;
  threshold: CMItemCount; triggerTokenOut: PCMBufferQueueTriggerToken)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMBufferQueueInstallTriggerWithIntegerThreshold';
function CMBufferQueueInstallTriggerHandler(queue: CMBufferQueueRef;
  condition: CMBufferQueueTriggerCondition; time: CMTime;
  triggerTokenOut: PCMBufferQueueTriggerToken;
  handler: CMBufferQueueTriggerHandler): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueInstallTriggerHandler';
function CMBufferQueueInstallTriggerHandlerWithIntegerThreshold
  (queue: CMBufferQueueRef; condition: CMBufferQueueTriggerCondition;
  threshold: CMItemCount; triggerTokenOut: PCMBufferQueueTriggerToken;
  handler: CMBufferQueueTriggerHandler): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMBufferQueueInstallTriggerHandlerWithIntegerThreshold';
function CMBufferQueueRemoveTrigger(queue: CMBufferQueueRef;
  triggerToken: CMBufferQueueTriggerToken): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueRemoveTrigger';
function CMBufferQueueTestTrigger(queue: CMBufferQueueRef;
  triggerToken: CMBufferQueueTriggerToken): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueTestTrigger';
function CMBufferQueueCallForEachBuffer(queue: CMBufferQueueRef;
  callback: TCoreMediaCallback1; refCon: Pointer): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueCallForEachBuffer';
function CMBufferQueueSetValidationCallback(queue: CMBufferQueueRef;
  callback: CMBufferValidationCallback; refCon: Pointer): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueSetValidationCallback';
function CMBufferQueueSetValidationHandler(queue: CMBufferQueueRef;
  handler: CMBufferValidationHandler): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMBufferQueueSetValidationHandler';
function CMFormatDescriptionCreate(allocator: CFAllocatorRef;
  mediaType: CMMediaType; mediaSubType: FourCharCode;
  extensions: CFDictionaryRef; formatDescriptionOut: PCMFormatDescriptionRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMFormatDescriptionCreate';
function CMFormatDescriptionGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMFormatDescriptionGetTypeID';
function CMFormatDescriptionEqual(formatDescription: CMFormatDescriptionRef;
  otherFormatDescription: CMFormatDescriptionRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMFormatDescriptionEqual';
function CMFormatDescriptionEqualIgnoringExtensionKeys(formatDescription
  : CMFormatDescriptionRef; otherFormatDescription: CMFormatDescriptionRef;
  formatDescriptionExtensionKeysToIgnore: CFTypeRef;
  sampleDescriptionExtensionAtomKeysToIgnore: CFTypeRef): Boolean; cdecl;
  external libCoreMedia name _PU +
  'CMFormatDescriptionEqualIgnoringExtensionKeys';
function CMFormatDescriptionGetMediaType(desc: CMFormatDescriptionRef)
  : CMMediaType; cdecl; external libCoreMedia name _PU +
  'CMFormatDescriptionGetMediaType';
function CMFormatDescriptionGetMediaSubType(desc: CMFormatDescriptionRef)
  : FourCharCode; cdecl; external libCoreMedia name _PU +
  'CMFormatDescriptionGetMediaSubType';
function CMFormatDescriptionGetExtensions(desc: CMFormatDescriptionRef)
  : CFDictionaryRef; cdecl;
  external libCoreMedia name _PU + 'CMFormatDescriptionGetExtensions';
function CMFormatDescriptionGetExtension(desc: CMFormatDescriptionRef;
  extensionKey: CFStringRef): CFPropertyListRef; cdecl;
  external libCoreMedia name _PU + 'CMFormatDescriptionGetExtension';
function CMAudioFormatDescriptionCreate(allocator: CFAllocatorRef;
  asbd: PInteger; layoutSize: LongWord; layout: PInteger;
  magicCookieSize: LongWord; magicCookie: Pointer; extensions: CFDictionaryRef;
  formatDescriptionOut: PCMAudioFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionCreate';
function CMAudioFormatDescriptionGetStreamBasicDescription
  (desc: CMAudioFormatDescriptionRef): PInteger; cdecl;
  external libCoreMedia name _PU +
  'CMAudioFormatDescriptionGetStreamBasicDescription';
function CMAudioFormatDescriptionGetMagicCookie
  (desc: CMAudioFormatDescriptionRef; sizeOut: PLongWord): Pointer; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetMagicCookie';
function CMAudioFormatDescriptionGetChannelLayout
  (desc: CMAudioFormatDescriptionRef; sizeOut: PLongWord): PInteger; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetChannelLayout';
function CMAudioFormatDescriptionGetFormatList
  (desc: CMAudioFormatDescriptionRef; sizeOut: PLongWord): PInteger; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetFormatList';
...
function CMAudioFormatDescriptionCreateSummary(allocator: CFAllocatorRef;
  formatDescriptionArray: CFArrayRef; flags: LongWord;
  formatDescriptionOut: PCMAudioFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionCreateSummary';
function CMAudioFormatDescriptionEqual(formatDescription
  : CMAudioFormatDescriptionRef;
  otherFormatDescription: CMAudioFormatDescriptionRef;
  equalityMask: CMAudioFormatDescriptionMask;
  equalityMaskOut: PCMAudioFormatDescriptionMask): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMAudioFormatDescriptionEqual';
function CMVideoFormatDescriptionCreate(allocator: CFAllocatorRef;
  codecType: CMVideoCodecType; width: Int32; height: Int32;
  extensions: CFDictionaryRef;
  formatDescriptionOut: PCMVideoFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMVideoFormatDescriptionCreate';
function CMVideoFormatDescriptionCreateForImageBuffer(allocator: CFAllocatorRef;
  imageBuffer: CVImageBufferRef;
  formatDescriptionOut: PCMVideoFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMVideoFormatDescriptionCreateForImageBuffer';
function CMVideoFormatDescriptionCreateFromH264ParameterSets
  (allocator: CFAllocatorRef; parameterSetCount: LongWord;
  parameterSetPointers: PByte; parameterSetSizes: PLongWord;
  NALUnitHeaderLength: Integer; formatDescriptionOut: PCMFormatDescriptionRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMVideoFormatDescriptionCreateFromH264ParameterSets';
function CMVideoFormatDescriptionCreateFromHEVCParameterSets
  (allocator: CFAllocatorRef; parameterSetCount: LongWord;
  parameterSetPointers: PByte; parameterSetSizes: PLongWord;
  NALUnitHeaderLength: Integer; extensions: CFDictionaryRef;
  formatDescriptionOut: PCMFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMVideoFormatDescriptionCreateFromHEVCParameterSets';
function CMVideoFormatDescriptionGetH264ParameterSetAtIndex
  (videoDesc: CMFormatDescriptionRef; parameterSetIndex: LongWord;
  parameterSetPointerOut: PByte; parameterSetSizeOut: PLongWord;
  parameterSetCountOut: PLongWord; NALUnitHeaderLengthOut: PInteger): OSStatus;
  cdecl; external libCoreMedia name _PU +
...
function CMVideoFormatDescriptionGetDimensions
  (videoDesc: CMVideoFormatDescriptionRef): CMVideoDimensions; cdecl;
  external libCoreMedia name _PU + 'CMVideoFormatDescriptionGetDimensions';
function CMVideoFormatDescriptionGetPresentationDimensions
  (videoDesc: CMVideoFormatDescriptionRef; usePixelAspectRatio: Boolean;
  useCleanAperture: Boolean): CGSize; cdecl;
  external libCoreMedia name _PU +
  'CMVideoFormatDescriptionGetPresentationDimensions';
function CMVideoFormatDescriptionGetCleanAperture
  (videoDesc: CMVideoFormatDescriptionRef; originIsAtTopLeft: Boolean): CGRect;
  cdecl; external libCoreMedia name _PU +
  'CMVideoFormatDescriptionGetCleanAperture';
function CMVideoFormatDescriptionGetExtensionKeysCommonWithImageBuffers
  : CFArrayRef; cdecl; external libCoreMedia name _PU +
  'CMVideoFormatDescriptionGetExtensionKeysCommonWithImageBuffers';
function CMVideoFormatDescriptionMatchesImageBuffer
  (desc: CMVideoFormatDescriptionRef; imageBuffer: CVImageBufferRef): Boolean;
  cdecl; external libCoreMedia name _PU +
  'CMVideoFormatDescriptionMatchesImageBuffer';
function CMMuxedFormatDescriptionCreate(allocator: CFAllocatorRef;
  muxType: CMMuxedStreamType; extensions: CFDictionaryRef;
  formatDescriptionOut: PCMMuxedFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMuxedFormatDescriptionCreate';
function CMTextFormatDescriptionGetDisplayFlags(desc: CMFormatDescriptionRef;
  displayFlagsOut: PCMTextDisplayFlags): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTextFormatDescriptionGetDisplayFlags';
function CMTextFormatDescriptionGetJustification(desc: CMFormatDescriptionRef;
  horizontaJustificationlOut: PCMTextJustificationValue;
  verticalJustificationOut: PCMTextJustificationValue): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTextFormatDescriptionGetJustification';
function CMTextFormatDescriptionGetDefaultTextBox(desc: CMFormatDescriptionRef;
  originIsAtTopLeft: Boolean; heightOfTextTrack: CGFloat;
  defaultTextBoxOut: PCGRect): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTextFormatDescriptionGetDefaultTextBox';
function CMTextFormatDescriptionGetDefaultStyle(desc: CMFormatDescriptionRef;
  localFontIDOut: PWord; boldOut: PBoolean; italicOut: PBoolean;
  underlineOut: PBoolean; fontSizeOut: PCGFloat; colorComponentsOut: CGFloat)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMTextFormatDescriptionGetDefaultStyle';
function CMTextFormatDescriptionGetFontName(desc: CMFormatDescriptionRef;
  localFontID: Word; fontNameOut: PCFStringRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTextFormatDescriptionGetFontName';
function CMTimeCodeFormatDescriptionCreate(allocator: CFAllocatorRef;
  timeCodeFormatType: CMTimeCodeFormatType; frameDuration: CMTime;
  frameQuanta: LongWord; flags: LongWord; extensions: CFDictionaryRef;
  formatDescriptionOut: PCMTimeCodeFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMTimeCodeFormatDescriptionCreate';
function CMTimeCodeFormatDescriptionGetFrameDuration(timeCodeFormatDescription
  : CMTimeCodeFormatDescriptionRef): CMTime; cdecl;
  external libCoreMedia name _PU +
  'CMTimeCodeFormatDescriptionGetFrameDuration';
function CMTimeCodeFormatDescriptionGetFrameQuanta(timeCodeFormatDescription
  : CMTimeCodeFormatDescriptionRef): LongWord; cdecl;
  external libCoreMedia name _PU + 'CMTimeCodeFormatDescriptionGetFrameQuanta';
function CMTimeCodeFormatDescriptionGetTimeCodeFlags
  (desc: CMTimeCodeFormatDescriptionRef): LongWord; cdecl;
  external libCoreMedia name _PU +
  'CMTimeCodeFormatDescriptionGetTimeCodeFlags';
function CMMetadataFormatDescriptionCreateWithKeys(allocator: CFAllocatorRef;
  metadataType: CMMetadataFormatType; keys: CFArrayRef;
  formatDescriptionOut: PCMMetadataFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMetadataFormatDescriptionCreateWithKeys';
function CMMetadataFormatDescriptionCreateWithMetadataSpecifications
  (allocator: CFAllocatorRef; metadataType: CMMetadataFormatType;
...
function CMMetadataFormatDescriptionCreateWithMetadataFormatDescriptionAndMetadataSpecifications
  (allocator: CFAllocatorRef; sourceDescription: CMMetadataFormatDescriptionRef;
  metadataSpecifications: CFArrayRef;
  formatDescriptionOut: PCMMetadataFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMMetadataFormatDescriptionGetKeyWithLocalID
  (desc: CMMetadataFormatDescriptionRef; localKeyID: OSType): CFDictionaryRef;
  cdecl; external libCoreMedia name _PU +
  'CMMetadataFormatDescriptionGetKeyWithLocalID';
function CMMetadataFormatDescriptionGetIdentifiers
  (desc: CMMetadataFormatDescriptionRef): CFArrayRef; cdecl;
  external libCoreMedia name _PU + 'CMMetadataFormatDescriptionGetIdentifiers';
function CMVideoFormatDescriptionCreateFromBigEndianImageDescriptionData
  (allocator: CFAllocatorRef; imageDescriptionData: PByte; size: LongWord;
  stringEncoding: CFStringEncoding; flavor: CMImageDescriptionFlavor;
  formatDescriptionOut: PCMVideoFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMVideoFormatDescriptionCreateFromBigEndianImageDescriptionBlockBuffer
  (allocator: CFAllocatorRef; imageDescriptionBlockBuffer: CMBlockBufferRef;
  stringEncoding: CFStringEncoding; flavor: CMImageDescriptionFlavor;
  formatDescriptionOut: PCMVideoFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMSwapBigEndianImageDescriptionToHost(imageDescriptionData: PByte;
  imageDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapBigEndianImageDescriptionToHost';
function CMSwapHostEndianImageDescriptionToBig(imageDescriptionData: PByte;
  imageDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapHostEndianImageDescriptionToBig';
function CMAudioFormatDescriptionCreateFromBigEndianSoundDescriptionData
  (allocator: CFAllocatorRef; soundDescriptionData: PByte; size: LongWord;
...
function CMAudioFormatDescriptionCreateFromBigEndianSoundDescriptionBlockBuffer
  (allocator: CFAllocatorRef; soundDescriptionBlockBuffer: CMBlockBufferRef;
  flavor: CMSoundDescriptionFlavor;
  formatDescriptionOut: PCMAudioFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMAudioFormatDescriptionCopyAsBigEndianSoundDescriptionBlockBuffer
  ...
  flavor: CMSoundDescriptionFlavor; blockBufferOut: PCMBlockBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
...
function CMDoesBigEndianSoundDescriptionRequireLegacyCBRSampleTableLayout
  ...
  flavor: CMSoundDescriptionFlavor): Boolean; cdecl;
  external libCoreMedia name _PU +
  'CMDoesBigEndianSoundDescriptionRequireLegacyCBRSampleTableLayout';
function CMSwapBigEndianSoundDescriptionToHost(soundDescriptionData: PByte;
  soundDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapBigEndianSoundDescriptionToHost';
function CMSwapHostEndianSoundDescriptionToBig(soundDescriptionData: PByte;
  soundDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapHostEndianSoundDescriptionToBig';
function CMTextFormatDescriptionCreateFromBigEndianTextDescriptionData
  (allocator: CFAllocatorRef; textDescriptionData: PByte; size: LongWord;
  flavor: CMTextDescriptionFlavor; mediaType: CMMediaType;
  formatDescriptionOut: PCMTextFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMTextFormatDescriptionCreateFromBigEndianTextDescriptionBlockBuffer
  (allocator: CFAllocatorRef; textDescriptionBlockBuffer: CMBlockBufferRef;
  flavor: CMTextDescriptionFlavor; mediaType: CMMediaType;
  formatDescriptionOut: PCMTextFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMTextFormatDescriptionCopyAsBigEndianTextDescriptionBlockBuffer
  (allocator: CFAllocatorRef; textFormatDescription: CMTextFormatDescriptionRef;
  flavor: CMTextDescriptionFlavor; blockBufferOut: PCMBlockBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU +
  'CMTextFormatDescriptionCopyAsBigEndianTextDescriptionBlockBuffer';
function CMSwapBigEndianTextDescriptionToHost(textDescriptionData: PByte;
  textDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapBigEndianTextDescriptionToHost';
function CMSwapHostEndianTextDescriptionToBig(textDescriptionData: PByte;
  textDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapHostEndianTextDescriptionToBig';
function CMClosedCaptionFormatDescriptionCreateFromBigEndianClosedCaptionDescriptionData
  (allocator: CFAllocatorRef; closedCaptionDescriptionData: PByte;
  size: LongWord; flavor: CMClosedCaptionDescriptionFlavor;
  formatDescriptionOut: PCMClosedCaptionFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMClosedCaptionFormatDescriptionCreateFromBigEndianClosedCaptionDescriptionBlockBuffer
  (allocator: CFAllocatorRef; closedCaptionDescriptionBlockBuffer
  : CMBlockBufferRef; flavor: CMClosedCaptionDescriptionFlavor;
  formatDescriptionOut: PCMClosedCaptionFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMClosedCaptionFormatDescriptionCopyAsBigEndianClosedCaptionDescriptionBlockBuffer
  (allocator: CFAllocatorRef; closedCaptionFormatDescription
  : CMClosedCaptionFormatDescriptionRef;
  flavor: CMClosedCaptionDescriptionFlavor; blockBufferOut: PCMBlockBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
...
function CMSwapBigEndianClosedCaptionDescriptionToHost
  (closedCaptionDescriptionData: PByte; closedCaptionDescriptionSize: LongWord)
  : OSStatus; cdecl; external libCoreMedia name _PU +
...
function CMTimeCodeFormatDescriptionCreateFromBigEndianTimeCodeDescriptionData
  (allocator: CFAllocatorRef; timeCodeDescriptionData: PByte; size: LongWord;
...
function CMTimeCodeFormatDescriptionCreateFromBigEndianTimeCodeDescriptionBlockBuffer
  (allocator: CFAllocatorRef; timeCodeDescriptionBlockBuffer: CMBlockBufferRef;
  flavor: CMTimeCodeDescriptionFlavor;
  formatDescriptionOut: PCMTimeCodeFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMTimeCodeFormatDescriptionCopyAsBigEndianTimeCodeDescriptionBlockBuffer
  ...
  flavor: CMTimeCodeDescriptionFlavor; blockBufferOut: PCMBlockBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMTimeCodeFormatDescriptionCopyAsBigEndianTimeCodeDescriptionBlockBuffer';
function CMSwapBigEndianTimeCodeDescriptionToHost(timeCodeDescriptionData
  : PByte; timeCodeDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapBigEndianTimeCodeDescriptionToHost';
function CMSwapHostEndianTimeCodeDescriptionToBig(timeCodeDescriptionData
  : PByte; timeCodeDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapHostEndianTimeCodeDescriptionToBig';
function CMMetadataFormatDescriptionCreateFromBigEndianMetadataDescriptionData
  (allocator: CFAllocatorRef; metadataDescriptionData: PByte; size: LongWord;
...
function CMMetadataFormatDescriptionCreateFromBigEndianMetadataDescriptionBlockBuffer
  (allocator: CFAllocatorRef; metadataDescriptionBlockBuffer: CMBlockBufferRef;
  flavor: CMMetadataDescriptionFlavor;
  formatDescriptionOut: PCMMetadataFormatDescriptionRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMMetadataFormatDescriptionCopyAsBigEndianMetadataDescriptionBlockBuffer
  ...
  flavor: CMMetadataDescriptionFlavor; blockBufferOut: PCMBlockBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMMetadataFormatDescriptionCopyAsBigEndianMetadataDescriptionBlockBuffer';
function CMSwapBigEndianMetadataDescriptionToHost(metadataDescriptionData
  : PByte; metadataDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapBigEndianMetadataDescriptionToHost';
function CMSwapHostEndianMetadataDescriptionToBig(metadataDescriptionData
  : PByte; metadataDescriptionSize: LongWord): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSwapHostEndianMetadataDescriptionToBig';
function CMMemoryPoolGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMMemoryPoolGetTypeID';
function CMMemoryPoolCreate(options: CFDictionaryRef): CMMemoryPoolRef; cdecl;
  external libCoreMedia name _PU + 'CMMemoryPoolCreate';
function CMMemoryPoolGetAllocator(pool: CMMemoryPoolRef): CFAllocatorRef; cdecl;
  external libCoreMedia name _PU + 'CMMemoryPoolGetAllocator';
procedure CMMemoryPoolFlush(pool: CMMemoryPoolRef); cdecl;
  external libCoreMedia name _PU + 'CMMemoryPoolFlush';
procedure CMMemoryPoolInvalidate(pool: CMMemoryPoolRef); cdecl;
  external libCoreMedia name _PU + 'CMMemoryPoolInvalidate';
function CMMetadataCreateIdentifierForKeyAndKeySpace(allocator: CFAllocatorRef;
  key: CFTypeRef; keySpace: CFStringRef; identifierOut: PCFStringRef): OSStatus;
  cdecl; external libCoreMedia name _PU +
  'CMMetadataCreateIdentifierForKeyAndKeySpace';
function CMMetadataCreateKeyFromIdentifier(allocator: CFAllocatorRef;
  identifier: CFStringRef; keyOut: PCFTypeRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMetadataCreateKeyFromIdentifier';
function CMMetadataCreateKeyFromIdentifierAsCFData(allocator: CFAllocatorRef;
  identifier: CFStringRef; keyOut: Pointer): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMetadataCreateKeyFromIdentifierAsCFData';
function CMMetadataCreateKeySpaceFromIdentifier(allocator: CFAllocatorRef;
  identifier: CFStringRef; keySpaceOut: PCFStringRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMetadataCreateKeySpaceFromIdentifier';
function CMMetadataDataTypeRegistryRegisterDataType(dataType: CFStringRef;
  description: CFStringRef; conformingDataTypes: CFArrayRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMMetadataDataTypeRegistryRegisterDataType';
function CMMetadataDataTypeRegistryDataTypeIsRegistered(dataType: CFStringRef)
  : Boolean; cdecl; external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryDataTypeIsRegistered';
function CMMetadataDataTypeRegistryGetDataTypeDescription(dataType: CFStringRef)
  : CFStringRef; cdecl; external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryGetDataTypeDescription';
function CMMetadataDataTypeRegistryGetConformingDataTypes(dataType: CFStringRef)
  : CFArrayRef; cdecl; external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryGetConformingDataTypes';
function CMMetadataDataTypeRegistryDataTypeConformsToDataType
  (dataType: CFStringRef; conformsToDataType: CFStringRef): Boolean; cdecl;
  external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryDataTypeConformsToDataType';
function CMMetadataDataTypeRegistryGetBaseDataTypes: CFArrayRef; cdecl;
  external libCoreMedia name _PU + 'CMMetadataDataTypeRegistryGetBaseDataTypes';
function CMMetadataDataTypeRegistryDataTypeIsBaseDataType(dataType: CFStringRef)
  : Boolean; cdecl; external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryDataTypeIsBaseDataType';
function CMMetadataDataTypeRegistryGetBaseDataTypeForConformingDataType
  (dataType: CFStringRef): CFStringRef; cdecl;
  external libCoreMedia name _PU +
  'CMMetadataDataTypeRegistryGetBaseDataTypeForConformingDataType';
function CMSampleBufferCreate(allocator: CFAllocatorRef;
  dataBuffer: CMBlockBufferRef; dataReady: Boolean;
  makeDataReadyCallback: CMSampleBufferMakeDataReadyCallback;
  makeDataReadyRefcon: Pointer; formatDescription: CMFormatDescriptionRef;
  numSamples: CMItemCount; numSampleTimingEntries: CMItemCount;
  sampleTimingArray: PCMSampleTimingInfo; numSampleSizeEntries: CMItemCount;
  sampleSizeArray: PLongWord; sampleBufferOut: PCMSampleBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferCreate';
function CMSampleBufferCreateWithMakeDataReadyHandler(allocator: CFAllocatorRef;
  dataBuffer: CMBlockBufferRef; dataReady: Boolean;
  formatDescription: CMFormatDescriptionRef; numSamples: CMItemCount;
  numSampleTimingEntries: CMItemCount; sampleTimingArray: PCMSampleTimingInfo;
  numSampleSizeEntries: CMItemCount; sampleSizeArray: PLongWord;
  sampleBufferOut: PCMSampleBufferRef;
  makeDataReadyHandler: CMSampleBufferMakeDataReadyHandler): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferCreateWithMakeDataReadyHandler';
function CMSampleBufferCreateReady(allocator: CFAllocatorRef;
  dataBuffer: CMBlockBufferRef; formatDescription: CMFormatDescriptionRef;
  numSamples: CMItemCount; numSampleTimingEntries: CMItemCount;
  sampleTimingArray: PCMSampleTimingInfo; numSampleSizeEntries: CMItemCount;
  sampleSizeArray: PLongWord; sampleBufferOut: PCMSampleBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferCreateReady';
function CMAudioSampleBufferCreateWithPacketDescriptions
  (allocator: CFAllocatorRef; dataBuffer: CMBlockBufferRef; dataReady: Boolean;
  makeDataReadyCallback: CMSampleBufferMakeDataReadyCallback;
  makeDataReadyRefcon: Pointer; formatDescription: CMFormatDescriptionRef;
  numSamples: CMItemCount; presentationTimeStamp: CMTime;
  packetDescriptions: PInteger; sampleBufferOut: PCMSampleBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU +
  'CMAudioSampleBufferCreateWithPacketDescriptions';
function CMAudioSampleBufferCreateWithPacketDescriptionsAndMakeDataReadyHandler
  (allocator: CFAllocatorRef; dataBuffer: CMBlockBufferRef; dataReady: Boolean;
  formatDescription: CMFormatDescriptionRef; numSamples: CMItemCount;
  presentationTimeStamp: CMTime; packetDescriptions: PInteger;
  sampleBufferOut: PCMSampleBufferRef;
  makeDataReadyHandler: CMSampleBufferMakeDataReadyHandler): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMAudioSampleBufferCreateReadyWithPacketDescriptions
  (allocator: CFAllocatorRef; dataBuffer: CMBlockBufferRef;
  formatDescription: CMFormatDescriptionRef; numSamples: CMItemCount;
  presentationTimeStamp: CMTime; packetDescriptions: PInteger;
  sampleBufferOut: PCMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMAudioSampleBufferCreateReadyWithPacketDescriptions';
function CMSampleBufferCreateForImageBuffer(allocator: CFAllocatorRef;
  imageBuffer: CVImageBufferRef; dataReady: Boolean;
  makeDataReadyCallback: CMSampleBufferMakeDataReadyCallback;
  makeDataReadyRefcon: Pointer; formatDescription: CMVideoFormatDescriptionRef;
  sampleTiming: PCMSampleTimingInfo; sampleBufferOut: PCMSampleBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferCreateForImageBuffer';
function CMSampleBufferCreateForImageBufferWithMakeDataReadyHandler
  (allocator: CFAllocatorRef; imageBuffer: CVImageBufferRef; dataReady: Boolean;
...
function CMSampleBufferCreateReadyWithImageBuffer(allocator: CFAllocatorRef;
  imageBuffer: CVImageBufferRef; formatDescription: CMVideoFormatDescriptionRef;
  sampleTiming: PCMSampleTimingInfo; sampleBufferOut: PCMSampleBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferCreateReadyWithImageBuffer';
function CMSampleBufferCreateCopy(allocator: CFAllocatorRef;
  sbuf: CMSampleBufferRef; sampleBufferOut: PCMSampleBufferRef): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferCreateCopy';
function CMSampleBufferCreateCopyWithNewTiming(allocator: CFAllocatorRef;
  originalSBuf: CMSampleBufferRef; numSampleTimingEntries: CMItemCount;
  sampleTimingArray: PCMSampleTimingInfo; sampleBufferOut: PCMSampleBufferRef)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferCreateCopyWithNewTiming';
function CMSampleBufferCopySampleBufferForRange(allocator: CFAllocatorRef;
  sbuf: CMSampleBufferRef; sampleRange: CFRange;
  sampleBufferOut: PCMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferCopySampleBufferForRange';
function CMSampleBufferGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetTypeID';
function CMSampleBufferSetDataBuffer(sbuf: CMSampleBufferRef;
  dataBuffer: CMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferSetDataBuffer';
function CMSampleBufferGetDataBuffer(sbuf: CMSampleBufferRef): CMBlockBufferRef;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetDataBuffer';
function CMSampleBufferGetImageBuffer(sbuf: CMSampleBufferRef)
  : CVImageBufferRef; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetImageBuffer';
function CMSampleBufferSetDataBufferFromAudioBufferList(sbuf: CMSampleBufferRef;
  blockBufferStructureAllocator: CFAllocatorRef;
  blockBufferBlockAllocator: CFAllocatorRef; flags: LongWord;
  bufferList: PInteger): OSStatus; cdecl;
  external libCoreMedia name _PU +
...
function CMSampleBufferGetAudioBufferListWithRetainedBlockBuffer
  ...
  bufferListOut: PInteger; bufferListSize: LongWord;
  blockBufferStructureAllocator: CFAllocatorRef;
  blockBufferBlockAllocator: CFAllocatorRef; flags: LongWord;
  blockBufferOut: PCMBlockBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferGetAudioBufferListWithRetainedBlockBuffer';
function CMSampleBufferGetAudioStreamPacketDescriptions(sbuf: CMSampleBufferRef;
  packetDescriptionsSize: LongWord; packetDescriptionsOut: PInteger;
  packetDescriptionsSizeNeededOut: PLongWord): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferGetAudioStreamPacketDescriptions';
function CMSampleBufferGetAudioStreamPacketDescriptionsPtr
  (sbuf: CMSampleBufferRef; packetDescriptionsPointerOut: PInteger;
  packetDescriptionsSizeOut: PLongWord): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferGetAudioStreamPacketDescriptionsPtr';
function CMSampleBufferCopyPCMDataIntoAudioBufferList(sbuf: CMSampleBufferRef;
  frameOffset: Int32; numFrames: Int32; bufferList: PInteger): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferCopyPCMDataIntoAudioBufferList';
function CMSampleBufferSetDataReady(sbuf: CMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferSetDataReady';
function CMSampleBufferDataIsReady(sbuf: CMSampleBufferRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferDataIsReady';
function CMSampleBufferSetDataFailed(sbuf: CMSampleBufferRef; status: OSStatus)
  : OSStatus; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferSetDataFailed';
function CMSampleBufferHasDataFailed(sbuf: CMSampleBufferRef;
  statusOut: POSStatus): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferHasDataFailed';
function CMSampleBufferMakeDataReady(sbuf: CMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferMakeDataReady';
function CMSampleBufferTrackDataReadiness(sbuf: CMSampleBufferRef;
  sampleBufferToTrack: CMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferTrackDataReadiness';
function CMSampleBufferInvalidate(sbuf: CMSampleBufferRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferInvalidate';
function CMSampleBufferSetInvalidateCallback(sbuf: CMSampleBufferRef;
  invalidateCallback: CMSampleBufferInvalidateCallback;
  invalidateRefCon: UInt64): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferSetInvalidateCallback';
function CMSampleBufferSetInvalidateHandler(sbuf: CMSampleBufferRef;
  invalidateHandler: CMSampleBufferInvalidateHandler): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferSetInvalidateHandler';
function CMSampleBufferIsValid(sbuf: CMSampleBufferRef): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferIsValid';
function CMSampleBufferGetNumSamples(sbuf: CMSampleBufferRef): CMItemCount;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetNumSamples';
function CMSampleBufferGetDuration(sbuf: CMSampleBufferRef): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetDuration';
function CMSampleBufferGetPresentationTimeStamp(sbuf: CMSampleBufferRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferGetPresentationTimeStamp';
function CMSampleBufferGetDecodeTimeStamp(sbuf: CMSampleBufferRef): CMTime;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetDecodeTimeStamp';
function CMSampleBufferGetOutputDuration(sbuf: CMSampleBufferRef): CMTime;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetOutputDuration';
function CMSampleBufferGetOutputPresentationTimeStamp(sbuf: CMSampleBufferRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferGetOutputPresentationTimeStamp';
function CMSampleBufferSetOutputPresentationTimeStamp(sbuf: CMSampleBufferRef;
  outputPresentationTimeStamp: CMTime): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferSetOutputPresentationTimeStamp';
function CMSampleBufferGetOutputDecodeTimeStamp(sbuf: CMSampleBufferRef)
  : CMTime; cdecl; external libCoreMedia name _PU +
  'CMSampleBufferGetOutputDecodeTimeStamp';
function CMSampleBufferGetSampleTimingInfoArray(sbuf: CMSampleBufferRef;
  numSampleTimingEntries: CMItemCount; timingArrayOut: PCMSampleTimingInfo;
  timingArrayEntriesNeededOut: PCMItemCount): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetSampleTimingInfoArray';
function CMSampleBufferGetOutputSampleTimingInfoArray(sbuf: CMSampleBufferRef;
  timingArrayEntries: CMItemCount; timingArrayOut: PCMSampleTimingInfo;
  timingArrayEntriesNeededOut: PCMItemCount): OSStatus; cdecl;
  external libCoreMedia name _PU +
  'CMSampleBufferGetOutputSampleTimingInfoArray';
function CMSampleBufferGetSampleTimingInfo(sbuf: CMSampleBufferRef;
  sampleIndex: CMItemIndex; timingInfoOut: PCMSampleTimingInfo): OSStatus;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetSampleTimingInfo';
function CMSampleBufferGetSampleSizeArray(sbuf: CMSampleBufferRef;
  sizeArrayEntries: CMItemCount; sizeArrayOut: PLongWord;
  sizeArrayEntriesNeededOut: PCMItemCount): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetSampleSizeArray';
function CMSampleBufferGetSampleSize(sbuf: CMSampleBufferRef;
  sampleIndex: CMItemIndex): LongWord; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetSampleSize';
function CMSampleBufferGetTotalSampleSize(sbuf: CMSampleBufferRef): LongWord;
  cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetTotalSampleSize';
function CMSampleBufferGetFormatDescription(sbuf: CMSampleBufferRef)
  : CMFormatDescriptionRef; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetFormatDescription';
function CMSampleBufferGetSampleAttachmentsArray(sbuf: CMSampleBufferRef;
  createIfNecessary: Boolean): CFArrayRef; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferGetSampleAttachmentsArray';
function CMSampleBufferCallForEachSample(sbuf: CMSampleBufferRef;
  callback: TCoreMediaCallback2; refCon: Pointer): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferCallForEachSample';
function CMSampleBufferCallBlockForEachSample(sbuf: CMSampleBufferRef;
  handler: TCoreMediaHandler): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSampleBufferCallBlockForEachSample';
function CMSimpleQueueGetTypeID: CFTypeID; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueGetTypeID';
function CMSimpleQueueCreate(allocator: CFAllocatorRef; capacity: Int32;
  queueOut: PCMSimpleQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueCreate';
function CMSimpleQueueEnqueue(queue: CMSimpleQueueRef; element: Pointer)
  : OSStatus; cdecl; external libCoreMedia name _PU + 'CMSimpleQueueEnqueue';
function CMSimpleQueueDequeue(queue: CMSimpleQueueRef): Pointer; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueDequeue';
function CMSimpleQueueGetHead(queue: CMSimpleQueueRef): Pointer; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueGetHead';
function CMSimpleQueueReset(queue: CMSimpleQueueRef): OSStatus; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueReset';
function CMSimpleQueueGetCapacity(queue: CMSimpleQueueRef): Int32; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueGetCapacity';
function CMSimpleQueueGetCount(queue: CMSimpleQueueRef): Int32; cdecl;
  external libCoreMedia name _PU + 'CMSimpleQueueGetCount';
function CMTimeRangeMake(start: CMTime; duration: CMTime): CMTimeRange; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeMake';
function CMTimeRangeGetUnion(range: CMTimeRange; otherRange: CMTimeRange)
  : CMTimeRange; cdecl; external libCoreMedia name _PU + 'CMTimeRangeGetUnion';
function CMTimeRangeGetIntersection(range: CMTimeRange; otherRange: CMTimeRange)
  : CMTimeRange; cdecl; external libCoreMedia name _PU +
  'CMTimeRangeGetIntersection';
function CMTimeRangeEqual(range1: CMTimeRange; range2: CMTimeRange): Boolean;
  cdecl; external libCoreMedia name _PU + 'CMTimeRangeEqual';
function CMTimeRangeContainsTime(range: CMTimeRange; time: CMTime): Boolean;
  cdecl; external libCoreMedia name _PU + 'CMTimeRangeContainsTime';
function CMTimeRangeContainsTimeRange(range: CMTimeRange;
  otherRange: CMTimeRange): Boolean; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeContainsTimeRange';
function CMTimeRangeGetEnd(range: CMTimeRange): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeGetEnd';
function CMTimeMapTimeFromRangeToRange(t: CMTime; fromRange: CMTimeRange;
  toRange: CMTimeRange): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMapTimeFromRangeToRange';
function CMTimeClampToRange(time: CMTime; range: CMTimeRange): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeClampToRange';
function CMTimeMapDurationFromRangeToRange(dur: CMTime; fromRange: CMTimeRange;
  toRange: CMTimeRange): CMTime; cdecl;
  external libCoreMedia name _PU + 'CMTimeMapDurationFromRangeToRange';
function CMTimeFoldIntoRange(time: CMTime; foldRange: CMTimeRange): CMTime;
  cdecl; external libCoreMedia name _PU + 'CMTimeFoldIntoRange';
function CMTimeRangeFromTimeToTime(start: CMTime; &end: CMTime): CMTimeRange;
  cdecl; external libCoreMedia name _PU + 'CMTimeRangeFromTimeToTime';
function CMTimeRangeCopyAsDictionary(range: CMTimeRange;
  allocator: CFAllocatorRef): CFDictionaryRef; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeCopyAsDictionary';
function CMTimeRangeMakeFromDictionary(dictionaryRepresentation
  : CFDictionaryRef): CMTimeRange; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeMakeFromDictionary';
function CMTimeRangeCopyDescription(allocator: CFAllocatorRef;
  range: CMTimeRange): CFStringRef; cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeCopyDescription';
procedure CMTimeRangeShow(range: CMTimeRange); cdecl;
  external libCoreMedia name _PU + 'CMTimeRangeShow';
function CMTimeMappingMake(source: CMTimeRange; target: CMTimeRange)
  : CMTimeMapping; cdecl; external libCoreMedia name _PU + 'CMTimeMappingMake';
function CMTimeMappingMakeEmpty(target: CMTimeRange): CMTimeMapping; cdecl;
  external libCoreMedia name _PU + 'CMTimeMappingMakeEmpty';
function CMTimeMappingCopyAsDictionary(mapping: CMTimeMapping;
  allocator: CFAllocatorRef): CFDictionaryRef; cdecl;
  external libCoreMedia name _PU + 'CMTimeMappingCopyAsDictionary';
function CMTimeMappingMakeFromDictionary(dictionaryRepresentation
  : CFDictionaryRef): CMTimeMapping; cdecl;
  external libCoreMedia name _PU + 'CMTimeMappingMakeFromDictionary';
function CMTimeMappingCopyDescription(allocator: CFAllocatorRef;
  mapping: CMTimeMapping): CFStringRef; cdecl;
  external libCoreMedia name _PU + 'CMTimeMappingCopyDescription';
procedure CMTimeMappingShow(mapping: CMTimeMapping); cdecl;
  external libCoreMedia name _PU + 'CMTimeMappingShow';
...
begin
  Result := CocoaPointerConst(libCoreMedia,
    'kCMImageDescriptionFlavor_ISOFamilyWithAppleExtensions');
end;
