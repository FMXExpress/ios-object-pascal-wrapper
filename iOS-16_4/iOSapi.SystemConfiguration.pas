...
{$M+}
  ...
  PAuthorizationRef = ^AuthorizationRef;
...
function DHCPClientPreferencesCopyApplicationOptions(applicationID: CFStringRef;
  count: PCFIndex): PByte; cdecl; external libSystemConfiguration name _PU +
...
function SCDynamicStoreCreate(allocator: CFAllocatorRef; name: CFStringRef;
  callout: SCDynamicStoreCallBack; context: PSCDynamicStoreContext)
  : SCDynamicStoreRef; cdecl; external libSystemConfiguration name _PU +
...
function SCNetworkCheckReachabilityByAddress(address: Pointer;
  addrlen: LongWord; flags: PSCNetworkConnectionFlags): Boolean; cdecl;
  external libSystemConfiguration name _PU +
  'SCNetworkCheckReachabilityByAddress';
function SCNetworkCheckReachabilityByName(nodename: MarshaledAString;
  flags: PSCNetworkConnectionFlags): Boolean; cdecl;
...
function SCPreferencesSetCallback(prefs: SCPreferencesRef;
  callout: SCPreferencesCallBack; context: PSCPreferencesContext): Boolean;
  cdecl; external libSystemConfiguration name _PU + 'SCPreferencesSetCallback';
...
function SCNetworkReachabilityGetFlags(target: SCNetworkReachabilityRef;
  flags: PSCNetworkReachabilityFlags): Boolean; cdecl;
...
function SCNetworkConnectionCopyUserPreferences(selectionOptions
  : CFDictionaryRef; serviceID: PCFStringRef; userOptions: PCFDictionaryRef)
  : Boolean; cdecl; external libSystemConfiguration name _PU +
...
function SCNetworkInterfaceCopyMediaOptions(&interface: SCNetworkInterfaceRef;
  current: PCFDictionaryRef; active: PCFDictionaryRef; available: PCFArrayRef;
  filter: Boolean): Boolean; cdecl;
  external libSystemConfiguration name _PU +
