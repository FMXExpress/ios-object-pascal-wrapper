...
function(param1: CTFontDescriptorRef; param2: CTFontDescriptorRef;
  param3: Pointer): CFComparisonResult;
cdecl;
...
TCoreTextCreateMatchesCallback =
function(param1: CFDictionaryRef; param2: Pointer { pid_t } ): CFArrayRef;
cdecl;
...
TCoreTextBlock =
procedure(param1: Double; param2: CFIndex; param3: Integer; param4: PInteger)
  of object;
...
CTParagraphStyleSetting = record spec: CTParagraphStyleSpecifier;
valueSize:
LongWord;
value:
Pointer;
...
function(param1: Pointer): CGFloat;
cdecl;
...
CTRunDelegateCallbacks = record version: CFIndex;
dealloc:
CTRunDelegateDeallocateCallback;
getAscent:
CTRunDelegateGetAscentCallback;
...
SFNTLookupBinarySearchHeader = record unitSize: UInt16;
nUnits:
UInt16;
searchRange:
UInt16;
...
SFNTLookupArrayHeader = record lookupValues: array [0 .. 0] of SFNTLookupValue;
end;
PSFNTLookupArrayHeader = ^SFNTLookupArrayHeader;

SFNTLookupTrimmedArrayHeader = record firstGlyph: UInt16;
count:
UInt16;
valueArray:
array [0 .. 0] of SFNTLookupValue;
end;
PSFNTLookupTrimmedArrayHeader = ^SFNTLookupTrimmedArrayHeader;

SFNTLookupSegment = record lastGlyph: UInt16;
firstGlyph:
UInt16;
value:
array [0 .. 0] of UInt16;
...
SFNTLookupSegmentHeader = record binSearch: SFNTLookupBinarySearchHeader;
segments:
array [0 .. 0] of SFNTLookupSegment;
end;
PSFNTLookupSegmentHeader = ^SFNTLookupSegmentHeader;

SFNTLookupSingle = record glyph: UInt16;
value:
array [0 .. 0] of UInt16;
end;
PSFNTLookupSingle = ^SFNTLookupSingle;

SFNTLookupSingleHeader = record binSearch: SFNTLookupBinarySearchHeader;
entries:
array [0 .. 0] of SFNTLookupSingle;
end;
...
SFNTLookupTable = record format: SFNTLookupTableFormat;
fsHeader:
SFNTLookupFormatSpecificHeader;
end;
PSFNTLookupTable = ^SFNTLookupTable;

SFNTLookupTablePtr = Pointer;
SFNTLookupTableHandle = Pointer;
STClass = Byte;
STEntryIndex = Byte;

STHeader = record filler: Byte;
nClasses:
STClass;
classTableOffset:
UInt16;
...
STClassTable = record firstGlyph: UInt16;
nGlyphs:
UInt16;
classes:
array [0 .. 0] of STClass;
end;
PSTClassTable = ^STClassTable;

STEntryZero = record newState: UInt16;
flags:
UInt16;
end;
PSTEntryZero = ^STEntryZero;

STEntryOne = record newState: UInt16;
flags:
UInt16;
offset1:
UInt16;
...
STEntryTwo = record newState: UInt16;
flags:
UInt16;
offset1:
UInt16;
...
STXHeader = record nClasses: UInt32;
classTableOffset:
UInt32;
stateArrayOffset:
UInt32;
...
STXEntryZero = record newState: STXStateIndex;
flags:
UInt16;
end;
PSTXEntryZero = ^STXEntryZero;

STXEntryOne = record newState: STXStateIndex;
flags:
UInt16;
index1:
UInt16;
...
STXEntryTwo = record newState: STXStateIndex;
flags:
UInt16;
index1:
UInt16;
...
LcarCaretClassEntry = record count: UInt16;
partials:
array [0 .. 0] of UInt16;
end;
PLcarCaretClassEntry = ^LcarCaretClassEntry;

LcarCaretTable = record version: Integer;
format:
UInt16;
lookup:
SFNTLookupTable;
...
LcarCaretTablePtr = Pointer;
JustPCActionType = UInt16;
JustificationFlags = UInt16;

JustPCDecompositionAction = record lowerLimit: Integer;
upperLimit:
Integer;
order:
UInt16;
...
JustPCConditionalAddAction = record substThreshold: Integer;
addGlyph:
UInt16;
substGlyph:
UInt16;
...
JustPCDuctilityAction = record ductilityAxis: UInt32;
minimumLimit:
Integer;
noStretchValue:
Integer;
...
JustPCGlyphRepeatAddAction = record flags: UInt16;
glyph:
UInt16;
end;
PJustPCGlyphRepeatAddAction = ^JustPCGlyphRepeatAddAction;

JustPCActionSubrecord = record theClass: UInt16;
theType:
JustPCActionType;
length:
UInt32;
...
JustPCAction = record actionCount: UInt32;
actions:
array [0 .. 0] of JustPCActionSubrecord;
end;
PJustPCAction = ^JustPCAction;

JustWidthDeltaEntry = record justClass: UInt32;
beforeGrowLimit:
Integer;
beforeShrinkLimit:
Integer;
...
JustWidthDeltaGroup = record count: UInt32;
entries:
array [0 .. 0] of JustWidthDeltaEntry;
end;
PJustWidthDeltaGroup = ^JustWidthDeltaGroup;

JustPostcompTable = record lookupTable: SFNTLookupTable;
end;
PJustPostcompTable = ^JustPostcompTable;

JustDirectionTable = record justClass: UInt16;
widthDeltaClusters:
UInt16;
postcomp:
UInt16;
...
JustTable = record version: Integer;
format:
UInt16;
horizHeaderOffset:
UInt16;
...
OpbdSideValues = record leftSideShift: Int16;
topSideShift:
Int16;
rightSideShift:
Int16;
...
OpbdTable = record version: Integer;
format:
OpbdTableFormat;
lookupTable:
SFNTLookupTable;
...
MortRearrangementSubtable = record header: STHeader;
end;
PMortRearrangementSubtable = ^MortRearrangementSubtable;

MortContextualSubtable = record header: STHeader;
substitutionTableOffset:
UInt16;
end;
PMortContextualSubtable = ^MortContextualSubtable;

MortLigatureSubtable = record header: STHeader;
...
MortSwashSubtable = record lookup: SFNTLookupTable;
end;
PMortSwashSubtable = ^MortSwashSubtable;

MortInsertionSubtable = record header: STHeader;
end;
...
MortSubtable = record length: UInt16;
coverage:
UInt16;
flags:
...
MortFeatureEntry = record featureType: UInt16;
featureSelector:
UInt16;
enableFlags:
MortSubtableMaskFlags;
...
UInt16;
featureEntries:
array [0 .. 0] of MortFeatureEntry;
end;
PMortChain = ^MortChain;

MortTable = record version: Integer;
nChains:
UInt32;
chains:
array [0 .. 0] of MortChain;
end;
PMortTable = ^MortTable;

MorxRearrangementSubtable = record header: STXHeader;
end;
PMorxRearrangementSubtable = ^MorxRearrangementSubtable;

MorxContextualSubtable = record header: STXHeader;
substitutionTableOffset:
UInt32;
end;
PMorxContextualSubtable = ^MorxContextualSubtable;

MorxLigatureSubtable = record header: STXHeader;
ligatureActionTableOffset:
UInt32;
componentTableOffset:
UInt32;
...
MorxInsertionSubtable = record header: STXHeader;
...
MorxSubtable = record length: UInt32;
coverage:
UInt32;
flags:
MortSubtableMaskFlags;
...
MorxChain = record defaultFlags: MortSubtableMaskFlags;
length:
UInt32;
nFeatures:
UInt32;
...
MorxTable = record version: Integer;
nChains:
UInt32;
chains:
array [0 .. 0] of MorxChain;
end;
PMorxTable = ^MorxTable;

PropCharProperties = UInt16;

PropTable = record version: Integer;
format:
UInt16;
defaultProps:
PropCharProperties;
...
PropLookupSegment = record lastGlyph: UInt16;
firstGlyph:
UInt16;
value:
UInt16;
...
PropLookupSingle = record glyph: UInt16;
props:
PropCharProperties;
end;
...
TrakTableEntry = record track: Integer;
nameTableIndex:
UInt16;
sizesOffset:
UInt16;
...
TrakTableData = record nTracks: UInt16;
nSizes:
UInt16;
sizeTableOffset:
UInt32;
trakTable:
array [0 .. 0] of TrakTableEntry;
end;
PTrakTableData = ^TrakTableData;

trakTable = record version: Integer;
format:
UInt16;
horizOffset:
UInt16;
...
KernVersion0Header = record version: UInt16;
nTables:
UInt16;
firstSubtable:
array [0 .. 0] of UInt16;
...
KernTableHeader = record version: Integer;
nTables:
Int32;
firstSubtable:
array [0 .. 0] of UInt16;
...
KernTableHeaderPtr = Pointer;
KernTableHeaderHandle = Pointer;

KernKerningPair = record left: UInt16;
right:
UInt16;
end;
PKernKerningPair = ^KernKerningPair;

KernOrderedListEntry = record pair: KernKerningPair;
value:
KernKerningValue;
end;
PKernOrderedListEntry = ^KernOrderedListEntry;

KernOrderedListEntryPtr = Pointer;

KernOrderedListHeader = record nPairs: UInt16;
searchRange:
UInt16;
entrySelector:
UInt16;
...
KernStateHeader = record header: STHeader;
valueTable:
UInt16;
firstTable:
array [0 .. 0] of Byte;
...
KernStateEntry = record newState: UInt16;
flags:
UInt16;
end;
PKernStateEntry = ^KernStateEntry;

KernOffsetTable = record firstGlyph: UInt16;
nGlyphs:
UInt16;
offsetTable:
array [0 .. 0] of KernArrayOffset;
end;
PKernOffsetTable = ^KernOffsetTable;

KernOffsetTablePtr = Pointer;

KernSimpleArrayHeader = record rowWidth: UInt16;
leftOffsetTable:
UInt16;
rightOffsetTable:
UInt16;
...
KernIndexArrayHeader = record glyphCount: UInt16;
kernValueCount:
Byte;
leftClassCount:
Byte;
...
KernVersion0SubtableHeader = record version: UInt16;
length:
UInt16;
stInfo:
KernSubtableInfo;
...
KernSubtableHeader = record length: Int32;
stInfo:
KernSubtableInfo;
tupleIndex:
Int16;
...
KernSubtableHeaderPtr = Pointer;
KerxSubtableCoverage = UInt32;
KerxArrayOffset = UInt32;

KerxTableHeader = record version: Integer;
nTables:
UInt32;
firstSubtable:
array [0 .. 0] of UInt32;
...
KerxTableHeaderPtr = Pointer;
KerxTableHeaderHandle = Pointer;

KerxKerningPair = record left: UInt16;
right:
UInt16;
end;
PKerxKerningPair = ^KerxKerningPair;

KerxOrderedListEntry = record pair: KerxKerningPair;
value:
KernKerningValue;
end;
PKerxOrderedListEntry = ^KerxOrderedListEntry;

KerxOrderedListEntryPtr = Pointer;

KerxOrderedListHeader = record nPairs: UInt32;
searchRange:
UInt32;
entrySelector:
UInt32;
...
KerxStateHeader = record header: STXHeader;
valueTable:
UInt32;
firstTable:
array [0 .. 0] of Byte;
...
KerxStateEntry = record newState: UInt16;
flags:
UInt16;
valueIndex:
UInt16;
...
KerxControlPointHeader = record header: STXHeader;
flags:
UInt32;
firstTable:
array [0 .. 0] of Byte;
...
KerxControlPointEntry = record newState: UInt16;
flags:
UInt16;
actionIndex:
UInt16;
...
KerxControlPointAction = record markControlPoint: UInt16;
currControlPoint:
UInt16;
end;
PKerxControlPointAction = ^KerxControlPointAction;

KerxAnchorPointAction = record markAnchorPoint: UInt16;
currAnchorPoint:
UInt16;
end;
PKerxAnchorPointAction = ^KerxAnchorPointAction;

KerxCoordinateAction = record markX: UInt16;
markY:
UInt16;
currX:
UInt16;
...
KerxSimpleArrayHeader = record rowWidth: UInt32;
leftOffsetTable:
UInt32;
rightOffsetTable:
UInt32;
...
KerxIndexArrayHeader = record glyphCount: UInt16;
kernValueCount:
UInt16;
leftClassCount:
UInt16;
...
KerxSubtableHeader = record length: UInt32;
stInfo:
...
KerxSubtableHeaderPtr = Pointer;
BslnBaselineClass = UInt32;
BslnBaselineRecord = array [0 .. 31] of Integer;

BslnFormat0Part = record deltas: array [0 .. 31] of Int16;
end;
PBslnFormat0Part = ^BslnFormat0Part;

BslnFormat1Part = record deltas: array [0 .. 31] of Int16;
mappingData:
SFNTLookupTable;
end;
PBslnFormat1Part = ^BslnFormat1Part;

BslnFormat2Part = record stdGlyph: UInt16;
ctlPoints:
array [0 .. 31] of Int16;
end;
PBslnFormat2Part = ^BslnFormat2Part;

BslnFormat3Part = record stdGlyph: UInt16;
ctlPoints:
array [0 .. 31] of Int16;
mappingData:
SFNTLookupTable;
...
BslnTable = record version: Integer;
format:
BslnTableFormat;
defaultBaseline:
UInt16;
...
BslnTablePtr = Pointer;

ALMXHeader = record version: Integer;
flags:
UInt16;
NMasters:
UInt16;
...
ALMXGlyphEntry = record GlyphIndexOffset: Int16;
HorizontalAdvance:
Int16;
XOffsetToHOrigin:
Int16;
...
ROTAHeader = record version: Integer;
flags:
UInt16;
NMasters:
UInt16;
...
ROTAGlyphEntry = record GlyphIndexOffset: Int16;
HBaselineOffset:
Int16;
VBaselineOffset:
Int16;
...
AnchorPoint = record x: Int16;
y:
Int16;
end;
PAnchorPoint = ^AnchorPoint;

AnchorPointTable = record nPoints: UInt32;
points:
array [0 .. 0] of AnchorPoint;
end;
PAnchorPointTable = ^AnchorPointTable;

AnkrTable = record version: UInt16;
flags:
UInt16;
lookupTableOffset:
UInt32;
...
LtagStringRange = record offset: UInt16;
length:
UInt16;
end;
PLtagStringRange = ^LtagStringRange;

LtagTable = record version: UInt32;
flags:
UInt32;
numTags:
UInt32;
tagRange:
array [0 .. 0] of LtagStringRange;
end;
PLtagTable = ^LtagTable;

sfntDirectoryEntry = record tableTag: FourCharCode;
checkSum:
UInt32;
offset:
UInt32;
...
sfntDirectory = record format: FourCharCode;
numOffsets:
UInt16;
searchRange:
UInt16;
...
UInt16;
table:
array [0 .. 0] of sfntDirectoryEntry;
end;
PsfntDirectory = ^sfntDirectory;

sfntCMapSubHeader = record format: UInt16;
length:
UInt16;
languageID:
UInt16;
...
sfntCMapExtendedSubHeader = record format: UInt16;
reserved:
UInt16;
length:
UInt32;
...
sfntCMapEncoding = record platformID: UInt16;
scriptID:
UInt16;
offset:
UInt32;
...
sfntCMapHeader = record version: UInt16;
numTables:
UInt16;
encoding:
array [0 .. 0] of sfntCMapEncoding;
end;
PsfntCMapHeader = ^sfntCMapHeader;

sfntNameRecord = record platformID: UInt16;
scriptID:
UInt16;
languageID:
UInt16;
...
sfntNameHeader = record format: UInt16;
count:
UInt16;
stringOffset:
UInt16;
rec:
array [0 .. 0] of sfntNameRecord;
end;
PsfntNameHeader = ^sfntNameHeader;

sfntVariationAxis = record axisTag: FourCharCode;
minValue:
Integer;
defaultValue:
Integer;
...
sfntInstance = record nameID: Int16;
flags:
Int16;
coord:
...
sfntVariationHeader = record version: Integer;
offsetToData:
UInt16;
countSizePairs:
UInt16;
...
UInt16;
axis:
array [0 .. 0] of sfntVariationAxis;
instance:
array [0 .. 0] of sfntInstance;
end;
PsfntVariationHeader = ^sfntVariationHeader;

sfntFontDescriptor = record name: FourCharCode;
value:
Integer;
end;
PsfntFontDescriptor = ^sfntFontDescriptor;

sfntDescriptorHeader = record version: Integer;
descriptorCount:
Int32;
descriptor:
array [0 .. 0] of sfntFontDescriptor;
end;
PsfntDescriptorHeader = ^sfntDescriptorHeader;

sfntFeatureName = record featureType: UInt16;
settingCount:
UInt16;
offsetToSettings:
Int32;
...
sfntFontFeatureSetting = record setting: UInt16;
nameID:
Int16;
end;
PsfntFontFeatureSetting = ^sfntFontFeatureSetting;

sfntFontRunFeature = record featureType: UInt16;
setting:
UInt16;
end;
PsfntFontRunFeature = ^sfntFontRunFeature;

sfntFeatureHeader = record version: Int32;
featureNameCount:
UInt16;
featureSetCount:
UInt16;
...
Int32;
names:
array [0 .. 0] of sfntFeatureName;
settings:
array [0 .. 0] of sfntFontFeatureSetting;
runs:
array [0 .. 0] of sfntFontRunFeature;
end;
...
FontVariation = record name: FourCharCode;
value:
Integer;
end;
                          ...
                          function kCTFontCascadeListAttribute: Pointer;
                            function kCTFontCharacterSetAttribute: Pointer;
                              function kCTFontLanguagesAttribute: Pointer;
                                function kCTFontBaselineAdjustAttribute
                                  : Pointer;
                                  function kCTFontMacintoshEncodingsAttribute
                                    : Pointer;
                                    function kCTFontFeaturesAttribute: Pointer;
                                      function kCTFontFeatureSettingsAttribute
                                        : Pointer;
                                        function kCTFontFixedAdvanceAttribute
                                        : Pointer;
                                        function kCTFontOrientationAttribute
                                        : Pointer;
                                        function kCTFontFormatAttribute
                                        : Pointer;
                                        function kCTFontRegistrationScopeAttribute
                                        : Pointer;
                                        function kCTFontPriorityAttribute
                                        : Pointer;
                                        function kCTFontEnabledAttribute
                                        : Pointer;
                                        function kCTFontDownloadableAttribute
                                        : Pointer;
                                        function kCTFontDownloadedAttribute
                                        : Pointer;
                                        function kCTFontDescriptorMatchingSourceDescriptor
                                        : Pointer;
                                        function kCTFontDescriptorMatchingDescriptors
                                        : Pointer;
                                        function kCTFontDescriptorMatchingResult
                                        : Pointer;
                                        function kCTFontDescriptorMatchingPercentage
                                        : Pointer;
                                        function kCTFontDescriptorMatchingCurrentAssetSize
                                        : Pointer;
                                        function kCTFontDescriptorMatchingTotalDownloadedSize
                                        : Pointer;
                                        function kCTFontDescriptorMatchingTotalAssetSize
                                        : Pointer;
                                        function kCTFontDescriptorMatchingError
                                        : Pointer;
                                        function kCTFontCopyrightNameKey
                                        : Pointer;
                                        function kCTFontFamilyNameKey: Pointer;
                                        function kCTFontSubFamilyNameKey
                                        : Pointer;
                                        ...
                                        function kCTFontPostScriptNameKey
                                        : Pointer;
                                        function kCTFontTrademarkNameKey
                                        : Pointer;
                                        function kCTFontManufacturerNameKey
                                        : Pointer;
                                        function kCTFontDesignerNameKey
                                        : Pointer;
                                        function kCTFontDescriptionNameKey
                                        : Pointer;
                                        function kCTFontVendorURLNameKey
                                        : Pointer;
                                        function kCTFontDesignerURLNameKey
                                        : Pointer;
                                        function kCTFontLicenseNameKey: Pointer;
                                        function kCTFontLicenseURLNameKey
                                        : Pointer;
                                        function kCTFontSampleTextNameKey
                                        : Pointer;
                                        function kCTFontPostScriptCIDNameKey
                                        : Pointer;
                                        function kCTFontVariationAxisIdentifierKey
                                        : Pointer;
                                        function kCTFontVariationAxisMinimumValueKey
                                        : Pointer;
                                        function kCTFontVariationAxisMaximumValueKey
                                        : Pointer;
                                        function kCTFontVariationAxisDefaultValueKey
                                        : Pointer;
                                        function kCTFontVariationAxisNameKey
                                        : Pointer;
                                        function kCTFontOpenTypeFeatureTag
                                        : Pointer;
                                        function kCTFontOpenTypeFeatureValue
                                        : Pointer;
                                        function kCTFontFeatureTypeIdentifierKey
                                        : Pointer;
                                        function kCTFontFeatureTypeNameKey
                                        : Pointer;
                                        function kCTFontFeatureTypeExclusiveKey
                                        : Pointer;
                                        function kCTFontFeatureTypeSelectorsKey
                                        : Pointer;
                                        function kCTFontFeatureSelectorIdentifierKey
                                        : Pointer;
                                        function kCTFontFeatureSelectorNameKey
                                        : Pointer;
                                        function kCTFontFeatureSelectorDefaultKey
                                        : Pointer;
                                        function kCTFontFeatureSelectorSettingKey
                                        : Pointer;
                                        function kCTBaselineClassRoman: Pointer;
                                        function kCTBaselineClassIdeographicCentered
                                        : Pointer;
                                        function kCTBaselineClassIdeographicLow
                                        : Pointer;
                                        function kCTBaselineClassIdeographicHigh
                                        : Pointer;
                                        function kCTBaselineClassHanging
                                        : Pointer;
                                        function kCTBaselineClassMath: Pointer;
                                        function kCTBaselineReferenceFont
                                        : Pointer;
                                        function kCTBaselineOriginalFont
                                        : Pointer;
                                        function kCTFontCollectionRemoveDuplicatesOption
                                        : Pointer;
                                        function kCTFontCollectionIncludeDisabledFontsOption
                                        : Pointer;
                                        function kCTFontCollectionDisallowAutoActivationOption
                                        : Pointer;
                                        function kCTFontManagerErrorDomain
                                        : Pointer;
                                        function kCTFontManagerErrorFontURLsKey
                                        : Pointer;
                                        function kCTFontManagerBundleIdentifier
                                        : Pointer;
                                        function kCTFontManagerRegisteredFontsChangedNotification
                                        : Pointer;
                                        function kCTFrameProgressionAttributeName
                                        : Pointer;
                                        function kCTFramePathFillRuleAttributeName
                                        : Pointer;
                                        function kCTFramePathWidthAttributeName
                                        : Pointer;
                                        function kCTFrameClippingPathsAttributeName
                                        : Pointer;
                                        function kCTFramePathClippingPathAttributeName
                                        : Pointer;
                                        function kCTTypesetterOptionDisableBidiProcessing
                                        : Pointer;
                                        function kCTTypesetterOptionForcedEmbeddingLevel
                                        : Pointer;
                                        function kCTFontAttributeName: Pointer;
                                        function kCTForegroundColorFromContextAttributeName
                                        : Pointer;
                                        function kCTKernAttributeName: Pointer;
                                        function kCTLigatureAttributeName
                                        : Pointer;
                                        function kCTForegroundColorAttributeName
                                        : Pointer;
                                        function kCTParagraphStyleAttributeName
                                        : Pointer;
                                        function kCTStrokeWidthAttributeName
                                        : Pointer;
                                        function kCTStrokeColorAttributeName
                                        : Pointer;
                                        function kCTUnderlineStyleAttributeName
                                        : Pointer;
                                        function kCTSuperscriptAttributeName
                                        : Pointer;
                                        function kCTUnderlineColorAttributeName
                                        : Pointer;
                                        function kCTVerticalFormsAttributeName
                                        : Pointer;
                                        function kCTGlyphInfoAttributeName
                                        : Pointer;
                                        function kCTCharacterShapeAttributeName
                                        : Pointer;
                                        function kCTLanguageAttributeName
                                        : Pointer;
                                        function kCTRunDelegateAttributeName
                                        : Pointer;
                                        function kCTBaselineClassAttributeName
                                        : Pointer;
                                        function kCTBaselineInfoAttributeName
                                        : Pointer;
                                        function kCTBaselineReferenceInfoAttributeName
                                        : Pointer;
                                        function kCTWritingDirectionAttributeName
                                        : Pointer;
                                        function kCTRubyAnnotationAttributeName
                                        : Pointer;
                                        function kCTTabColumnTerminatorsAttributeName
                                        : Pointer;
                                        ...
                                        language: Pointer): CFTypeRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontDescriptorCopyLocalizedAttribute';
                                        function CTFontGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        'CTFontGetTypeID';
                                        function CTFontCreateWithName
                                        (name: CFStringRef; size: CGFloat;
                                        matrix: Pointer): CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontCreateWithName';
                                        function CTFontCreateWithFontDescriptor
                                        (descriptor: CTFontDescriptorRef;
                                        size: CGFloat; matrix: Pointer)
                                        : CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontCreateWithFontDescriptor';
                                        function CTFontCreateWithNameAndOptions
                                        (name: CFStringRef; size: CGFloat;
                                        matrix: Pointer; options: CTFontOptions)
                                        : CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef; size: CGFloat;
                                        matrix: Pointer; family: CFStringRef)
                                        : CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        cdecl; external libCoreText name _PU +
                                        'CTFontCopyAttribute';
                                        function CTFontGetSize(font: CTFontRef)
                                        : CGFloat; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetSize';
                                        ...
                                        (font: CTFontRef): CTFontSymbolicTraits;
                                        cdecl; external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef): CFStringRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        function CTFontCopyName(font: CTFontRef;
                                        nameKey: CFStringRef): CFStringRef;
                                        cdecl; external libCoreText name _PU +
                                        'CTFontCopyName';
                                        function CTFontCopyLocalizedName
                                        (font: CTFontRef; nameKey: CFStringRef;
                                        actualLanguage: Pointer): CFStringRef;
                                        cdecl; external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef): Cardinal; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetUnitsPerEm';
                                        function CTFontGetGlyphCount
                                        (font: CTFontRef): CFIndex; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetGlyphCount';
                                        function CTFontGetBoundingBox
                                        (font: CTFontRef): CGRect; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef;
                                        glyphName: CFStringRef): CGGlyph; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetGlyphWithName';
                                        function CTFontGetBoundingRectsForGlyphs
                                        (font: CTFontRef;
                                        orientation: CTFontOrientation;
                                        glyphs: CGGlyph; boundingRects: Pointer;
                                        count: CFIndex): CGRect; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetBoundingRectsForGlyphs';
                                        function CTFontGetOpticalBoundsForGlyphs
                                        (font: CTFontRef; glyphs: CGGlyph;
                                        boundingRects: Pointer; count: CFIndex;
                                        options: CFOptionFlags): CGRect; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetOpticalBoundsForGlyphs';
                                        function CTFontGetAdvancesForGlyphs
                                        (font: CTFontRef;
                                        orientation: CTFontOrientation;
                                        glyphs: CGGlyph; advances: Pointer;
                                        count: CFIndex): Double; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontGetAdvancesForGlyphs';
                                        procedure CTFontGetVerticalTranslationsForGlyphs
                                        (font: CTFontRef; glyphs: CGGlyph;
                                        translations: CGSize; count: CFIndex);
                                        cdecl; external libCoreText name _PU +
                                        'CTFontGetVerticalTranslationsForGlyphs';
                                        function CTFontCreatePathForGlyph
                                        (font: CTFontRef; glyph: CGGlyph;
                                        matrix: Pointer): CGPathRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef; attributes: Pointer)
                                        : CGFontRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFontCopyGraphicsFont';
                                        function CTFontCreateWithGraphicsFont
                                        (graphicsFont: CGFontRef; size: CGFloat;
                                        matrix: Pointer;
                                        attributes: CTFontDescriptorRef)
                                        : CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        identifier: Int16; style: Byte;
                                        size: CGFloat): CTFontRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (font: CTFontRef; table: CTFontTableTag;
                                        options: CTFontTableOptions): CFDataRef;
                                        cdecl; external libCoreText name _PU +
                                        'CTFontCopyTable';
                                        procedure CTFontDrawGlyphs
                                        (font: CTFontRef; glyphs: CGGlyph;
                                        positions: CGPoint; count: LongWord;
                                        ...
                                        (font: CTFontRef; glyph: CGGlyph;
                                        positions: PCGFloat;
                                        maxPositions: CFIndex): CFIndex; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        sortCallback
                                        : CTFontCollectionSortDescriptorsCallback;
                                        refCon: Pointer): CFArrayRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        procedure CTFontManagerSetAutoActivationSetting
                                        ...
                                        function CTFrameGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        'CTFrameGetTypeID';
                                        function CTFrameGetStringRange
                                        (frame: CTFrameRef): CFRange; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (frame: CTFrameRef): CGPathRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFrameGetPath';
                                        ...
                                        (frame: CTFrameRef): CFArrayRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTFrameGetLines';
                                        procedure CTFrameGetLineOrigins
                                        (frame: CTFrameRef; range: CFRange;
                                        origins: CGPoint); cdecl;
                                        external libCoreText name _PU +
                                        'CTFrameGetLineOrigins';
                                        procedure CTFrameDraw(frame: CTFrameRef;
                                        context: CGContextRef); cdecl;
                                        external libCoreText name _PU +
                                        'CTFrameDraw';
                                        function CTLineGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        'CTLineGetTypeID';
                                        ...
                                        stringRange: CFRange; offset: Double)
                                        : CTLineRef; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        (typesetter: CTTypesetterRef;
                                        startIndex: CFIndex; width: Double;
                                        offset: Double): CFIndex; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        stringRange: CFRange; path: CGPathRef;
                                        ...
                                        stringRange: CFRange;
                                        frameAttributes: CFDictionaryRef;
                                        constraints: CGSize; fitRange: Pointer)
                                        : CGSize; cdecl;
                                        external libCoreText name _PU +
                                        'CTFramesetterSuggestFrameSizeWithConstraints';
                                        function CTGlyphInfoGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        ...
                                        valueBufferSize: LongWord;
                                        valueBuffer: Pointer): Integer; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        sizeFactor: CGFloat; text: CFStringRef)
                                        ...
                                        (rubyAnnotation: CTRubyAnnotationRef;
                                        position: CTRubyPosition): CFStringRef;
                                        cdecl; external libCoreText name _PU +
                                        'CTRubyAnnotationGetTextForPosition';
                                        function CTRunGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        'CTRunGetTypeID';
                                        function CTRunGetGlyphCount
                                        (run: CTRunRef): CFIndex; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetGlyphCount';
                                        function CTRunGetAttributes
                                        (run: CTRunRef): CFDictionaryRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetAttributes';
                                        function CTRunGetStatus(run: CTRunRef)
                                        : CTRunStatus; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetStatus';
                                        function CTRunGetGlyphsPtr
                                        (run: CTRunRef): unsigned short *;
                                        cdecl; external libCoreText name _PU +
                                        'CTRunGetGlyphsPtr';
                                        procedure CTRunGetGlyphs(run: CTRunRef;
                                        range: CFRange; buffer: CGGlyph); cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetGlyphs';
                                        function CTRunGetPositionsPtr
                                        (run: CTRunRef): Pointer; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetPositionsPtr';
                                        procedure CTRunGetPositions
                                        (run: CTRunRef; range: CFRange;
                                        buffer: CGPoint); cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetPositions';
                                        ...
                                        external libCoreText name _PU +
                                        'CTRunGetAdvancesPtr';
                                        procedure CTRunGetAdvances
                                        (run: CTRunRef; range: CFRange;
                                        buffer: CGSize); cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetAdvances';
                                        function CTRunGetStringIndicesPtr
                                        (run: CTRunRef): PLongInt; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetStringIndicesPtr';
                                        procedure CTRunGetStringIndices
                                        (run: CTRunRef; range: CFRange;
                                        buffer: CFIndex); cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetStringIndices';
                                        function CTRunGetStringRange
                                        (run: CTRunRef): CFRange; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetStringRange';
                                        function CTRunGetTypographicBounds
                                        (run: CTRunRef; range: CFRange;
                                        ascent: PCGFloat; descent: PCGFloat;
                                        leading: PCGFloat): Double; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunGetTypographicBounds';
                                        function CTRunGetImageBounds
                                        (run: CTRunRef; context: CGContextRef;
                                        ...
                                        cdecl; external libCoreText name _PU +
                                        'CTRunGetTextMatrix';
                                        procedure CTRunDraw(run: CTRunRef;
                                        context: CGContextRef; range: CFRange);
                                        cdecl; external libCoreText name _PU +
                                        'CTRunDraw';
                                        ...
                                        (callbacks: Pointer; refCon: Pointer)
                                        : CTRunDelegateRef; cdecl;
                                        external libCoreText name _PU +
                                        'CTRunDelegateCreate';
                                        ...
                                        function CTTextTabGetTypeID: CFTypeID;
                                        cdecl; external libCoreText name _PU +
                                        'CTTextTabGetTypeID';
                                        ...
                                        (tab: CTTextTabRef): CTTextAlignment;
                                        cdecl; external libCoreText name _PU +
                                        'CTTextTabGetAlignment';
                                        function CTTextTabGetLocation
                                        (tab: CTTextTabRef): Double; cdecl;
                                        external libCoreText name _PU +
                                        ...
                                        cdecl; external libCoreText name _PU +
                                        'CTTextTabGetOptions';
                                        function CTGetCoreTextVersion: LongWord;
                                        cdecl; external libCoreText name _PU +
